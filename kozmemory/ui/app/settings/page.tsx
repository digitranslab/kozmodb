...
export default function SettingsPage() {
  ...
  const [settings, setSettings] = useState({
    kozmemory: configState.kozmemory || {
      custom_instructions: null
    },
    kozmodb: configState.kozmodb
  })
  ...
  useEffect(() => {
    setSettings(prev => ({
      ...prev,
      kozmemory: configState.kozmemory || { custom_instructions: null },
      kozmodb: configState.kozmodb
    }))
  }, [configState.kozmemory, configState.kozmodb])

  const handleSave = async () => {
    try {
      await saveConfig({ 
        kozmemory: settings.kozmemory,
        kozmodb: settings.kozmodb
      })
      toast({
      ...
      <div className="container mx-auto py-10 max-w-4xl">
        <div className="flex justify-between items-center mb-8">
          <div className="animate-fade-slide-down">
            ...
            <p className="text-muted-foreground mt-1">Manage your KozMemory and Kozmodb configuration</p>
          </div>
