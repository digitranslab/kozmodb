...
This directory contains the backend API for KozMemory, built with FastAPI and SQLAlchemy. This also runs the Kozmodb MCP Server that you can use with MCP clients to remember things.
