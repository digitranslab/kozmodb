"""
Memory client utilities for KozMemory.

This module provides functionality to initialize and manage the Kozmodb memory client
...
def get_memory_client(custom_instructions: str = None):
    """
    Get or initialize the Kozmodb client.

    Args:
        custom_instructions: Optional instructions for the memory project.

    Returns:
        Initialized Kozmodb client instance or None if initialization fails.
    ...
    try:
        ...
        try:
            ...
            if db_config:
                ...
                # Extract custom instructions from kozmemory settings
                if "kozmemory" in json_config and "custom_instructions" in json_config["kozmemory"]:
                    db_custom_instructions = json_config["kozmemory"]["custom_instructions"]
