...
def app():
    ...
    try:
        with TemporaryDirectory(prefix="skills_test_") as temp_dir:
            ...
            app = initialize_app()
            app._kozmodb_temp_dir = temp_dir
            yield app
    except PermissionError:
        print("PermissionError when deleting temporary directory. KozmoDBs temp dir is going to be left as is.")
...
def create_dummy_db(client: FlaskClient, db_name: str):
    temp_dir = client.application._kozmodb_temp_dir
