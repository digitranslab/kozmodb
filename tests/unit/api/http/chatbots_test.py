...
def test_get_all_chatbots(client, test_db):
    response = client.get('/api/projects/kozmodb/chatbots', follow_redirects=True)
    ...
    client.post('/api/projects/kozmodb/chatbots', json=chatbot_data, follow_redirects=True)
...
def test_get_chatbot(client, test_db):
    ...
    response = client.get('/api/projects/kozmodb/chatbots/test_get_chatbot', follow_redirects=True)
    assert response.status_code == HTTPStatus.OK
...
def test_get_chatbot_not_found(client):
    response = client.get('/api/projects/kozmodb/chatbots/test_get_chatbot_not_found', follow_redirects=True)
    assert response.status_code == HTTPStatus.NOT_FOUND
...
def test_post_chatbot(client, test_db):
    ...
    response = client.post('/api/projects/kozmodb/chatbots', json=chatbot_data, follow_redirects=True)
...
def test_put_chatbot_create(client, test_db):
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_create', json=chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.CREATED
    created_chatbot = response.get_json()
...
def test_put_chatbot_update(client, test_db):
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_update', json=chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.CREATED
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_update', json=updated_chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.OK
...
def test_put_chatbot_model_not_found(client, test_db):
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_model_not_found', json=chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.NOT_FOUND
...
def test_put_chatbot_create_no_name_fails(client, test_db):
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_create_no_name_fails', json=chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.BAD_REQUEST
...
def test_put_chatbot_create_no_model_fails(client, test_db):
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_create_no_model_fails', json=chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.BAD_REQUEST
...
def test_put_chatbot_create_no_database_id_fails(client):
    ...
    response = client.put('/api/projects/kozmodb/chatbots/test_put_chatbot_create_no_database_id_fails', json=chatbot_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.BAD_REQUEST
...
def test_delete_chatbot(client, test_db):
    ...
    response = client.delete('/api/projects/kozmodb/chatbots/test_delete_chatbot', follow_redirects=True)
    assert response.status_code == HTTPStatus.NO_CONTENT


def test_delete_chatbot_not_found(client):
    response = client.delete('/api/projects/kozmodb/chatbots/test_delete_chatbot_not_found', follow_redirects=True)
    assert response.status_code == HTTPStatus.NOT_FOUND
