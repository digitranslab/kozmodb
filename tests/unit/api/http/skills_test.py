...
def test_get_all_skills(client):
    response = client.get('/api/projects/kozmodb/skills', follow_redirects=True)
...
def test_get_skill(client):
    ...
    client.post('/api/projects/kozmodb/skills', json=create_request, follow_redirects=True)

    get_response = client.get('/api/projects/kozmodb/skills/test_get_skill', follow_redirects=True)
...
def test_get_skill_not_found(client):
    get_response = client.get('/api/projects/kozmodb/skills/test_get_skill_not_found', follow_redirects=True)
...
def test_post_skill_no_skill(client):
    ...
    create_response = client.post('/api/projects/kozmodb/skills', json=malformed_request, follow_redirects=True)
...
def test_put_skill_create(client):
    ...
    create_response = client.put('/api/projects/kozmodb/skills/test_put_skill_create', json=create_request, follow_redirects=True)
    assert create_response.status_code == HTTPStatus.CREATED
    created_skill = create_response.get_json()
...
def test_put_skill_update(client):
    ...
    create_response = client.put('/api/projects/kozmodb/skills/test_put_skill_update', json=create_request, follow_redirects=True)
    assert create_response.status_code == HTTPStatus.CREATED
    ...
    create_response = client.put('/api/projects/kozmodb/skills/test_put_skill_update', json=update_request, follow_redirects=True)
...
def test_put_skill_no_skill(client):
    ...
    update_response = client.put('/api/projects/kozmodb/skills/test_put_skill_no_skill', json=malformed_request, follow_redirects=True)
...
def test_delete_skill(client):
    ...
    delete_response = client.delete('/api/projects/kozmodb/skills/test_delete_skill', follow_redirects=True)
    assert delete_response.status_code == HTTPStatus.NO_CONTENT


def test_delete_skill_not_found(client):
    delete_response = client.delete('/api/projects/kozmodb/skills/test_delete_skill_not_found', follow_redirects=True)
