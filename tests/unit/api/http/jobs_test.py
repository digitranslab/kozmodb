...
def test_jobs_flow(client):
    ...
    response = client.post("/api/projects/kozmodb/jobs", json=request)
    ...
    response = client.get("/api/projects/kozmodb/jobs/test_job")
    assert response.status_code == HTTPStatus.OK
    ...
    response = client.get("/api/projects/kozmodb/jobs/test_job/history")
    assert response.status_code == HTTPStatus.OK
    # no executions
    ...
    response = client.get("/api/projects/kozmodb/jobs")
    assert response.status_code == HTTPStatus.OK
    ...
    response = client.delete("/api/projects/kozmodb/jobs/test_job")
