...
class TestGenericApiKeyHandling(unittest.TestCase):
    ...
    @patch("kozmodb.interfaces.agents.agents_controller.AgentsController.check_model_provider")
    @patch("kozmodb.interfaces.agents.agents_controller.AgentsController.get_agent")
    @patch("kozmodb.interfaces.agents.agents_controller.ProjectController")
    @patch("kozmodb.interfaces.storage.db.session")
    def test_add_agent_with_generic_api_key(
        ...
        with patch("kozmodb.interfaces.storage.db.Agents", return_value=mock_agent):
            # Add the agent
    ...
    def test_add_agent_with_both_api_keys(
        ...
        with patch("kozmodb.interfaces.agents.langchain_agent.get_api_key") as mock_get_api_key:
