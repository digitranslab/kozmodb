...
from kozmodb.api.executor.planner.query_planner import KOZMODB_SQL_FUNCTIONS
...
class TestPlanIntegrationSelect:
    ...
    def test_no_integration_error(self):
        ...
        with pytest.raises(PlanningException):
            plan_query(query, integrations=[], predictor_namespace='kozmodb')
    ...
    def test_select_with_kozmodb_functions(self):
        for function in KOZMODB_SQL_FUNCTIONS:
            query = parse_sql(
                f'''
