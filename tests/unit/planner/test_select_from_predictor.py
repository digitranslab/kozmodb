...
from kozmodb_sql_parser.ast import (Identifier, Select, Constant, Star, Parameter, BinaryOperation)
...
class TestPlanSelectFromPredictor:
        ...
        expected_plan = QueryPlan(
            ...
            steps=[
                ApplyPredictorRowStep(
                    namespace='kozmodb', predictor=Identifier('pred'),
                    row_dict={'x1': 1, 'x2': '2'}
                ),
            ],
    ...
    def test_select_from_predictor_plan_predictor_alias(self):
        ...
        expected_plan = QueryPlan(
            ...
            steps=[
                ApplyPredictorRowStep(
                    namespace='kozmodb', predictor=Identifier('pred', alias=Identifier('pred_alias')),
                    row_dict={'x1': 1, 'x2': '2'}
                ),
            ],
        )
    ...
    def test_select_from_predictor_default_namespace(self):
        ...
        plan = plan_query(
            query, predictor_namespace='kozmodb', default_namespace='kozmodb', predictor_metadata={'pred': {}}
        )
    ...
    def test_select_from_predictor_get_columns(self):
        ...
        plan = plan_query(
            query, predictor_namespace='kozmodb', default_namespace='kozmodb',
    ...
    def test_using_predictor_version(self):
        ...
        expected_plan = QueryPlan(
            ...
            steps=[
                ApplyPredictorRowStep(
                    namespace='kozmodb', predictor=Identifier(parts=['pred', '21']),
                    row_dict={'x1': 1}
                )
            ],
        )
