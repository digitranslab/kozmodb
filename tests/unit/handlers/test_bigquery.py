...
try:
    from kozmodb.integrations.handlers.bigquery_handler.bigquery_handler import BigQueryHandler
except ImportError:
...
class TestBigQueryHandler(unittest.TestCase):
    ...
    def setUp(self):
        self.patcher_get_oauth2_credentials = patch(
            "kozmodb.integrations.utilities.handlers.auth_utilities.google.GoogleServiceAccountOAuth2Manager.get_oauth2_credentials"
        )
        self.patcher_client = patch("kozmodb.integrations.handlers.bigquery_handler.bigquery_handler.Client")
    ...
    def test_native_query(self):
        ...
        with patch(
            "kozmodb.integrations.handlers.bigquery_handler.bigquery_handler.QueryJobConfig"
