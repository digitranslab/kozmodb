...
try:
    from kozmodb.integrations.handlers.clickhouse_handler.clickhouse_handler import ClickHouseHandler
except ImportError:
...
class TestClickHouseHandler(BaseDatabaseHandlerTest, unittest.TestCase):
    ...
    def create_patcher(self):
        return patch(
            "kozmodb.integrations.handlers.clickhouse_handler.clickhouse_handler.create_engine",
