...
try:
    ...
    from kozmodb.integrations.handlers.salesforce_handler.salesforce_handler import SalesforceHandler
    from kozmodb.integrations.handlers.salesforce_handler.salesforce_tables import create_table_class
except ImportError:
    pytestmark = pytest.mark.skip("Salesforce handler not installed")

from kozmodb_sql_parser.ast import BinaryOperation, Constant, Identifier, Select, Star
