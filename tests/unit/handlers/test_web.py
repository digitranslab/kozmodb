...
from kozmodb.integrations.libs.api_handler_exceptions import TableAlreadyExists
from kozmodb.integrations.handlers.web_handler.web_handler import WebHandler
from kozmodb.integrations.handlers.web_handler.web_handler import CrawlerTable
from kozmodb.integrations.handlers.web_handler import urlcrawl_helpers as helpers
...
class TestWebHelpers(unittest.TestCase):
    ...
    @patch("kozmodb.integrations.handlers.web_handler.urlcrawl_helpers.get_all_website_links")
...
class TestWebHandler(unittest.TestCase):
    ...
    def test_web_cases(self, mock_get):
        ...
        # filters
        single_url = FilterCondition('url', FilterOperator.EQUAL, 'https://docs.kozmodb.com/')
        two_urls = FilterCondition('url', FilterOperator.IN, ('https://docs.kozmodb.com/', 'https://docs.python.org/'))
