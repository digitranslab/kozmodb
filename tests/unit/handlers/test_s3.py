...
from kozmodb_sql_parser.ast import Select, Identifier, Star, Constant

import pandas as pd

from base_handler_test import BaseHandlerTestSetup
from kozmodb.integrations.handlers.s3_handler.s3_handler import S3Handler
...
class TestS3Handler(BaseHandlerTestSetup, unittest.TestCase):
    ...
    @patch('kozmodb.integrations.handlers.s3_handler.s3_handler.S3Handler.query')
