...
try:
    ...
    from kozmodb.integrations.handlers.oracle_handler.oracle_handler import OracleHandler
except ImportError:
...
class TestOracleHandler(BaseDatabaseHandlerTest, unittest.TestCase):
    ...
    def create_patcher(self):
        return patch("kozmodb.integrations.handlers.oracle_handler.oracle_handler.connect")
    ...
    def test_query_method(self):
        ...
        with patch("kozmodb.integrations.handlers.oracle_handler.oracle_handler.SqlalchemyRender") as MockRenderer:
