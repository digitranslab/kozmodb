...
from kozmodb_sql_parser.ast import BinaryOperation, Constant, Delete, Identifier, Insert, Update
import pandas as pd

from base_handler_test import BaseAPIChatHandlerTest, BaseAPIResourceTestSetup
from kozmodb.integrations.libs.response import HandlerStatusResponse as StatusResponse, HandlerResponse as Response
from kozmodb.integrations.utilities.sql_utils import FilterCondition, FilterOperator

try:
    from slack_sdk.errors import SlackApiError
    from slack_sdk.web.slack_response import SlackResponse
    from kozmodb.integrations.handlers.slack_handler.slack_handler import SlackHandler
    from kozmodb.integrations.handlers.slack_handler.slack_tables import (
...
class TestSlackHandler(BaseAPIChatHandlerTest, unittest.TestCase):
    ...
    def create_patcher(self):
        return patch("kozmodb.integrations.handlers.slack_handler.slack_handler.WebClient")

    @patch("kozmodb.integrations.handlers.slack_handler.slack_handler.SocketModeClient")
