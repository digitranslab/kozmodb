...
from kozmodb.integrations.handlers.postgres_handler.postgres_handler import PostgresHandler
from kozmodb.integrations.libs.response import HandlerResponse as Response, RESPONSE_TYPE
...
class TestPostgresHandler(BaseDatabaseHandlerTest, unittest.TestCase):
    ...
    def test_connection_parameters(self):
        ...
        self.tearDown()
        self.setUp()
        self.handler.connection_args["connection_parameters"] = {"application_name": "kozmodb_test", "keepalives": 1}

        self.handler.connect()

        call_kwargs = self.mock_connect.call_args[1]

        self.assertEqual(call_kwargs["application_name"], "kozmodb_test")
        ...
        self.handler.connection_args["connection_parameters"] = {"application_name": "kozmodb_test"}
