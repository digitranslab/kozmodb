...
from kozmodb.integrations.handlers.mysql_handler.mysql_handler import MySQLHandler
from kozmodb.integrations.libs.response import HandlerResponse as Response, INF_SCHEMA_COLUMNS_NAMES_SET, RESPONSE_TYPE
...
class TestMySQLHandler(BaseDatabaseHandlerTest, unittest.TestCase):
    ...
    def test_unpack_config(self):
        ...
        """
        with patch("kozmodb.integrations.handlers.mysql_handler.mysql_handler.ConnectionConfig") as mock_config_class:
    ...
    def test_query_method(self):
        ...
        """
        with patch("kozmodb.integrations.handlers.mysql_handler.mysql_handler.SqlalchemyRender") as mock_renderer_class:
    ...
    def test_connection_with_conn_attrs(self):
        ...
        """
        self.handler.connection_data = self.dummy_connection_data.copy()
        self.handler.connection_data["conn_attrs"] = {"program_name": "kozmodb", "client_version": "1.0"}

        self.handler.connect()

        call_kwargs = self.mock_connect.call_args[1]
        self.assertEqual(call_kwargs["conn_attrs"], {"program_name": "kozmodb", "client_version": "1.0"})
