...
from kozmodb.integrations.handlers.mongodb_handler.mongodb_handler import MongoDBHandler
...
class TestMongoDBHandler(BaseHandlerTestSetup, unittest.TestCase):
    ...
    def create_patcher(self):
        return patch('kozmodb.integrations.handlers.mongodb_handler.mongodb_handler.MongoClient')
