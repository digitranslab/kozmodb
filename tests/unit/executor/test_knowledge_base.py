...
@contextmanager
def task_monitor():
    from kozmodb.interfaces.tasks.task_monitor import TaskMonitor
...
class TestKB(BaseExecutorDummyML):
    ...
    @patch("kozmodb.interfaces.knowledge_base.llm_client.OpenAI")
    @patch("kozmodb.integrations.utilities.rag.rerankers.base_reranker.BaseLLMReranker.get_scores")
    @patch("kozmodb.integrations.handlers.litellm_handler.litellm_handler.embedding")
