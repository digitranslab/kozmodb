...
from kozmodb.interfaces.storage import db  # noqa
from kozmodb.migrations import migrate  # noqa
from kozmodb.interfaces.storage.fs import RESOURCE_GROUP
from kozmodb.interfaces.storage.json import get_json_storage  # noqa
...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        os.environ["KOZMODB_STORAGE_DIR"] = os.environ.get("KOZMODB_STORAGE_DIR", cls._temp_dir.name)
        os.environ["KOZMODB_DB_CON"] = (
            "sqlite:///"
            + os.path.join(os.environ["KOZMODB_STORAGE_DIR"], "kozmodb.sqlite3.db")
