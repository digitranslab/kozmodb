...
from kozmodb.interfaces.knowledge_base.preprocessing.models import (
    Document,
    TextChunkingConfig,
    ContextualConfig,
)
from kozmodb.interfaces.knowledge_base.preprocessing.text_splitter import TextSplitter

# Mock all langchain imports to avoid pydantic version conflicts
with patch.dict(
    "sys.modules",
    {
        "kozmodb.interfaces.agents.langchain_agent": Mock(),
        "kozmodb.interfaces.agents.kozmodb_chat_model": Mock(),
        "kozmodb.interfaces.agents.constants": Mock(),
        "langchain_openai": Mock(),
    },
):
    from kozmodb.interfaces.knowledge_base.preprocessing.document_preprocessor import (
...
class TestContextualPreprocessor:
    ...
    def preprocessor_async(self):
        with patch(
            "kozmodb.interfaces.knowledge_base.preprocessing.document_preprocessor.create_chat_model"
