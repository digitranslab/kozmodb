...
from kozmodb.integrations.handlers.openai_handler.openai_handler import OpenAIHandler
from kozmodb.integrations.handlers.statsforecast_handler.statsforecast_handler import (
    StatsForecastHandler,
)
from kozmodb.integrations.libs.base import ArgProbeMixin
...
def test_openai_handler_probing(mock_openai_handler_class):
    ...
    # inspiring example in  https://github.com/digitranslab/kozmodb/issues/6846
    assert {
        "name": "enigne",
        "required": False,
    } not in handler.prediction_args()
