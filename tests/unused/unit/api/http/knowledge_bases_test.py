...
from kozmodb.api.mysql.mysql_proxy.mysql_proxy import SQLAnswer
...
def test_prepare(client):
    ...
    create_query = '''
    CREATE MODEL kozmodb.test_embedding_model
    PREDICT embeddings
    USING
    ...
    response = client.post('/api/projects/kozmodb/models', json=train_data, follow_redirects=True)
    assert response.status_code == HTTPStatus.CREATED


def test_get_knowledge_base(client):
    get_knowledge_bases_response = client.get('/api/projects/kozmodb/knowledge_bases')
    ...
    create_response = client.post('/api/projects/kozmodb/knowledge_bases', json=create_request, follow_redirects=True)
    ...
    get_knowledge_base_response = client.get('/api/projects/kozmodb/knowledge_bases/test_get_kb')
...
def test_delete_knowledge_base(client):
    ...
    delete_response = client.delete('/api/projects/kozmodb/knowledge_bases/test_delete_kb', follow_redirects=True)
    assert delete_response.status_code == HTTPStatus.NO_CONTENT

    get_response = client.get('/api/projects/kozmodb/knowledge_bases/test_delete_kb', follow_redirects=True)
...
def test_delete_knowledge_base_not_found(client):
    delete_response = client.delete('/api/projects/kozmodb/knowledge_bases/xiaolongbao_kb', follow_redirects=True)
    assert delete_response.status_code == HTTPStatus.NOT_FOUND
...
def test_put_knowledge_base_rows(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_update_rows',
            json=update_request,
...
def test_put_knowledge_base_query(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_update_query',
            json=update_request,
            follow_redirects=True
        )
...
def create_test_kb(client):
    ...
    client.delete(f'/api/projects/kozmodb/knowledge_bases/{kb_name}', follow_redirects=True)
    create_kb_request = {
        'knowledge_base': {
            'name': kb_name,
            'model': 'test_embedding_model'
    ...
    create_response = client.post('/api/projects/kozmodb/knowledge_bases', json=create_kb_request,
                                  follow_redirects=True)
...
def test_successful_completion(client, create_test_kb):
    ...
    response = client.post(f'/api/projects/kozmodb/knowledge_bases/{kb_name}/completions',
...
def test_completion_non_existent_knowledge_base(client):
    ...
    response = client.post('/api/projects/kozmodb/knowledge_bases/nonexistent_kb/completions',
                           json=completion_request, follow_redirects=True)
    assert response.status_code == HTTPStatus.NOT_FOUND
...
def test_create_knowledge_base_with_preprocessing(client):
    ...
    get_response = client.get('/api/projects/kozmodb/knowledge_bases/test_kb_preprocess')
...
def test_put_knowledge_base_with_preprocessing(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_update_preprocess',
            json=update_request,
            follow_redirects=True
        )
...
def test_put_knowledge_base_invalid_preprocessing(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_invalid_update_preprocess',
            json=update_request,
            follow_redirects=True
        )
...
def test_put_knowledge_base_with_documents(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_documents',
            json=update_request,
            follow_redirects=True
        )
...
def test_put_knowledge_base_mixed_content(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_mixed',
            json=update_request,
            follow_redirects=True
        )
...
def test_create_knowledge_base_with_text_chunking(client):
    ...
    # Verify preprocessing config is preserved in GET
    get_response = client.get('/api/projects/kozmodb/knowledge_bases/test_kb_text_chunking')
    assert get_response.status_code == HTTPStatus.OK
    kb_data = get_response.get_json()
    assert 'preprocessing' in kb_data['params']
    assert kb_data['params']['preprocessing'] == create_request['knowledge_base']['preprocessing']
...
def test_put_knowledge_base_default_preprocessing(client):
    ...
    update_response = client.put(
        '/api/projects/kozmodb/knowledge_bases/test_kb_default_preprocess',
        json=update_request,
        follow_redirects=True
    )
...
def test_put_knowledge_base_missing_metadata(client):
    ...
    update_response = client.put(
        '/api/projects/kozmodb/knowledge_bases/test_kb_metadata',
        json=update_request,
        follow_redirects=True
    )
...
def test_document_processing_with_valid_metadata(client):
    ...
    update_response = client.put(
        '/api/projects/kozmodb/knowledge_bases/test_kb_valid_metadata',
        json=update_request,
        follow_redirects=True
    )
...
def test_document_processing_with_default_metadata(client):
    ...
    with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
        ...
        update_response = client.put(
            '/api/projects/kozmodb/knowledge_bases/test_kb_default_metadata',
            json=update_request,
            follow_redirects=True
        )
...
def test_document_loader_with_file_extensions(client):
    ...
    # Create test files
    with patch('kozmodb.interfaces.file.file_controller.FileController') as mock_file_controller:
        ...
        with patch('kozmodb.interfaces.knowledge_base.controller.KnowledgeBaseTable') as mock_kb_table:
            ...
            update_response = client.put(
                '/api/projects/kozmodb/knowledge_bases/test_kb_file_extensions',
                json=update_request,
                follow_redirects=True
            )
...
def test_document_loader_sql_error_handling(client):
    ...
    update_response = client.put(
        '/api/projects/kozmodb/knowledge_bases/test_kb_sql_errors',
        json=update_request,
        follow_redirects=True
    )
...
def test_preprocessing_update(client):
    ...
    client.delete(
        f'/api/projects/kozmodb/knowledge_bases/{initial_request["knowledge_base"]["name"]}',
        follow_redirects=True
    )

    with patch('kozmodb.api.http.namespaces.knowledge_bases.SessionController') as mock_session_class:
        ...
        create_response = client.post(
            '/api/projects/kozmodb/knowledge_bases',
