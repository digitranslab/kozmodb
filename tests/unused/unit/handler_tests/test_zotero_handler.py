...
from kozmodb.integrations.handlers.zotero_handler.zotero_handler import ZoteroHandler
from kozmodb.integrations.handlers.zotero_handler.zotero_tables import AnnotationsTable
