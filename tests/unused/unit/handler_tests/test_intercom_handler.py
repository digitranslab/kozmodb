import unittest
from kozmodb.integrations.handlers.intercom_handler.intercom_handler import IntercomHandler
...
class InstatusHandlerTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.handler = IntercomHandler(name="kozmodb_intercon", connection_data={'access_token': os.environ.get('INTERCOM_ACCESS_TOKEN')})
