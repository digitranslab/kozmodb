from kozmodb.integrations.handlers.tripadvisor_handler.tripadvisor_handler import (
    TripAdvisorHandler,
)

from kozmodb.integrations.handlers.tripadvisor_handler.tripadvisor_table import (
    SearchLocationTable,
