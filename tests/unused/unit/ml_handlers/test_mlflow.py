...
from kozmodb.integrations.handlers.mlflow_handler.mlflow_handler import MLflowHandler
...
class TestMLFlow(BaseExecutorTest):
    ...
    @patch('kozmodb.integrations.handlers.mlflow_handler.mlflow_handler.requests.post')
    def test_mlflow(
            self,
            mock_internal_post,
        ...
        ret = self.run_sql('''
           CREATE PREDICTOR kozmodb.test_mlflow
           PREDICT c
           USING 
             engine='mlflow',
