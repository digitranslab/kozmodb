...
from kozmodb.integrations.handlers.unify_handler.unify_handler import UnifyHandler  # Replace with the actual import path
...
class TestUnify(unittest.TestCase):
    ...
    @patch('kozmodb.integrations.handlers.unify_handler.unify_handler.unify.utils.list_endpoints')
    @patch('kozmodb.integrations.handlers.unify_handler.unify_handler.get_api_key')
