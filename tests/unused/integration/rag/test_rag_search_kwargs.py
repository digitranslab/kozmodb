...
from kozmodb.integrations.utilities.rag.settings import (
    RAGPipelineModel,
    RetrieverType,
    SearchKwargs,
    SearchType,
...
from kozmodb.integrations.utilities.rag.pipelines.rag import LangChainRAGPipeline
...
class TestRAGSearchKwargs:
    ...
    def test_vector_store_retriever_search_kwargs(self):
        ...
        with patch('kozmodb.integrations.utilities.rag.vector_store.VectorStoreOperator') as mock_vs_op:
    ...
    def test_auto_retriever_search_kwargs(self):
        ...
        with patch('kozmodb.integrations.utilities.rag.retrievers.auto_retriever.AutoRetriever') as MockAutoRetriever, \
    ...
    def test_multi_vector_retriever_search_kwargs(self):
        ...
        with patch('kozmodb.integrations.utilities.rag.pipelines.rag.MultiVectorRetriever') as MockMultiRetrieverClass:
