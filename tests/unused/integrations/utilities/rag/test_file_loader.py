...
def test_load_md():
    loader = FileLoader('./kozmodb/integrations/handlers/langchain_handler/README.md')
    docs = loader.load()
    assert len(docs) == 1
    assert 'This documentation describes the integration of KozmoDB with LangChain' in docs[0].page_content
