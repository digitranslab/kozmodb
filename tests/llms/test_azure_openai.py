...
from kozmodb.llms.azure_openai import AzureOpenAILLM
...
def mock_openai_client():
    with patch("kozmodb.llms.azure_openai.AzureOpenAI") as mock_openai:
        mock_client = Mock()
...
def test_generate_with_http_proxies(default_headers):
    ...
    with (
        patch("kozmodb.llms.azure_openai.AzureOpenAI") as mock_azure_openai,
