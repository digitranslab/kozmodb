...
from kozmodb.configs.base import MemoryConfig
from kozmodb.memory.main import Memory
...
def test_custom_prompts(memory_custom_instance):
    ...
    with patch("kozmodb.memory.main.parse_messages", return_value="Test message") as mock_parse_messages:
        with patch(
            "kozmodb.memory.main.get_update_memory_messages", return_value="custom update memory prompt"
