---
title: Multimodal Demo with Kozmodb
---

<Snippet file="paper-release.mdx" />

Enhance your AI interactions with **Kozmodb**'s multimodal capabilities. Kozmodb now supports image understanding, allowing for richer context and more natural interactions across supported AI platforms.

> 🎉 Experience the power of multimodal AI! Test out Kozmodb's image understanding capabilities at [multimodal-demo.kozmodb.ai](https://multimodal-demo.kozmodb.ai)
...
Visit [multimodal-demo.kozmodb.ai](https://multimodal-demo.kozmodb.ai) to experience Kozmodb's multimodal capabilities firsthand. Upload images and see how Kozmodb understands and remembers visual context across your conversations.
