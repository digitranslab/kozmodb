...
- **Examples:** Added Healthcare assistant using Kozmodb and Google ADK
...
**New Features:**
- **KozMemory:** Added KozMemory support
...
**Bug Fixes:**
- Fixed kozmodb-migrations issue
...
**New Features:**
- **Integrations:** Added Kozmograph integration
...
- **Integrations:** Added Flowise integration documentation for Kozmodb memory setup
...
**New Features:**
- **Livekit Integration:** Added Kozmodb livekit example
...
- **Supabase History DB:** Added Supabase History DB to run Kozmodb OSS on Serverless
...
**Improvements:**
- **Client:** Added support for Kozmodb to work with Chrome Extensions
</Update>
...
**Improvements:**
- **Demo:** Updated Demo KozmodbAI
- **Client:** Enhanced Ping method in Kozmodb Client
...
- **Bump `kozmodb` to use `2.1.12`**

</Update>

<Update label="2025-03-26" description="v2.1.12">
**New Features:**
- **Kozmodb OSS:** Support infer param
...
- **Graph Playground:** Enabled for @kozmodb.ai users
