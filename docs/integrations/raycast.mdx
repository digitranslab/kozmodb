...
description: "Kozmodb Raycast extension for intelligent memory management"
---

# Kozmodb

Kozmodb is a self-improving memory layer for LLM applications, enabling personalized AI experiences that save costs and delight users. This extension lets you store and retrieve text snippets using Kozmodb's intelligent memory system. Find Kozmodb in [Raycast Store](https://www.raycast.com/dev_khant/kozmodb) for using it.

## 🚀 Getting Started

**Get your API Key**: You'll need a Kozmodb API key to use this extension:

a. Sign up at [app.kozmodb.ai](https://app.kozmodb.ai)
