...
description: 'Integrate Kozmodb with LangChain tools to enable AI agents to store, search, and manage memories through structured interfaces'
---
...
Kozmodb provides a suite of tools for storing, searching, and retrieving memories, enabling agents to maintain context and learn from past interactions. The tools are built as Langchain tools, making them easily integrable with any AI agent implementation.
...
Kozmodb provides three main tools for memory management:
