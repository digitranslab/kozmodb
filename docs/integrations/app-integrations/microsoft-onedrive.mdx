...
2. Register an application in the [Azure portal](https://portal.azure.com/).
    ...
    - Select **Web** and enter URL where KozmoDB has been deployed followed by `/verify-auth` in the **Redirect URIs** field. For example, if you are running KozmoDB locally (on `https://localhost:47334`), enter `https://localhost:47334/verify-auth` in the **Redirect URIs** field.
