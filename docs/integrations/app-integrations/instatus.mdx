...
In this section, we present how to connect Instatus to KozmoDB.
...
The Instatus Handler for KozmoDB offers an interface to connect with Instatus via APIs and retrieve status pages.
