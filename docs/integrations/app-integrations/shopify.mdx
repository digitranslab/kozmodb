...
In this section, we present how to connect Shopify to KozmoDB.
...
Data from Shopify can be utilized within KozmoDB to train AI models and chatbots using Products, Customers and Orders data, and make predictions relevant for businesses.
...
To connect your Shopify account to KozmoDB, you must first create a new handler instance. You can do it by the following query:
...
<Info>
For more information about available actions and development plans, visit [this page](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/handlers/shopify_handler/README.md).
</Info>
