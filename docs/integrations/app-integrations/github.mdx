...
In this section, we present how to connect GitHub repository to KozmoDB.
...
Data from GitHub, including issues and PRs, can be utilized within KozmoDB to make relevant predictions or automate the issue/PR creation.
...
2. To connect GitHub to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
Here is how to connect the KozmoDB GitHub repository:
...
The `kozmodb_github` connection contains two tables: `issues` and `pull_requests`.
...
<Info>
For more information about available actions and development plans, visit [this page](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/handlers/github_handler/README.md).
</Info>
