...
This documentation describes the integration of KozmoDB with [Confluence](https://www.atlassian.com/software/confluence), a popular collaboration and documentation tool developed by Atlassian.
The integration allows KozmoDB to access data from Confluence and enhance it with AI capabilities.
...
Establish a connection to Confluence from KozmoDB by executing the following SQL command and providing its [handler name](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/confluence_handler) as an engine.
