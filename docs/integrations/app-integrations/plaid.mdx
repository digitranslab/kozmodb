...
In this section, we present how to connect Plaid to KozmoDB.
...
Data from Plaid can be utilized within KozmoDB to train AI models and make financial forecasts.
...
2. To connect Plaid to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect the Plaid app to KozmoDB, the following syntax can be used:
...
<Info>
For more information about available actions and development plans, visit [this page](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/handlers/plaid_handler/README.md).
</Info>
