...
In this section, we present how to connect Email accounts to KozmoDB.

By connecting your email account to KozmoDB, you can utilize various AI models available within KozmoDB to summarize emails, detect spam, or even automate email replies.
...
VALUES ("toemail@outlook.com", "KozmoDB", "Hello from KozmoDB!");
```
