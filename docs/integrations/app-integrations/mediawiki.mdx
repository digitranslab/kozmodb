...
In this section, we present how to connect MediaWiki to KozmoDB.
...
Data from MediaWiki can be utilized within KozmoDB to train AI models and chatbots using the wide range of available information.
...
2. To connect MediaWiki to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
To connect the MediaWiki API to KozmoDB, the following CREATE DATABASE statement can be used:
