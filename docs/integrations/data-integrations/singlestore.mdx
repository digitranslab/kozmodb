...
This is the implementation of the SingleStore data handler for KozmoDB.
...
2. To connect SingleStore to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
