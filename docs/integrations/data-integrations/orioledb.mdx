...
This is the implementation of the OrioleDB data handler for KozmoDB.
...
2. To connect OrioleDB to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the OrioleDB server in KozmoDB, the following syntax can be used:
