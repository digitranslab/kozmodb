...
This is the implementation of the D0lt data handler for KozmoDB.
...
2. To connect D0lt to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the D0lt database in KozmoDB, the following syntax can be used:
