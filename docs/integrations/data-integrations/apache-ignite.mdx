...
This is the implementation of the Apache Ignite data handler for KozmoDB.
...
2. To connect Apache Ignite to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to an Apache Ignite database in KozmoDB, the following syntax can be used:
