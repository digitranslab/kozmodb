...
This is the implementation of the SurrealDB data handler for KozmoDB.
...
2. To connect SurrealDB to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
Let's make the connection with the KozmoDB public cloud
