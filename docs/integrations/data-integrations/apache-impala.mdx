...
This is the implementation of the Impala data handler for KozmoDB.
...
2. To connect Apache Impala to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the Impala database in KozmoDB, the following syntax can be used:
