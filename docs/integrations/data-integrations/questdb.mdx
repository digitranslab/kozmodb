...
This is the implementation of the QuestDB data handler for KozmoDB.
...
2. To connect QuestDB to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the QuestDB server in KozmoDB, the following syntax can be used:
