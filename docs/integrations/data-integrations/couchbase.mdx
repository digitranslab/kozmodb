...
This is the implementation of the Couchbase data handler for KozmoDB.
...
2. To connect Couchbase to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
