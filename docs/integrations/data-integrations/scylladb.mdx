...
This is the implementation of the ScyllaDB data handler for KozmoDB.
...
2. To connect ScyllaDB to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
