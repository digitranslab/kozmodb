...
This is the implementation of the Google Sheets data handler for KozmoDB.
...
<Warning>
Please note that the integration of KozmoDB with Google Sheets works for public sheets only.
</Warning>
...
2. To connect Google Sheets to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
