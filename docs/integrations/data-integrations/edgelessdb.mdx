...
This is the implementation of the EdgelessDB data handler for KozmoDB.
...
2. To connect EdgelessDB to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to use EdgelessDB as a data source in KozmoDB, you need to use the following syntax:
