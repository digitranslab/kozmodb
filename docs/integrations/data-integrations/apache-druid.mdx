...
This is the implementation of the Druid data handler for KozmoDB.
...
2. To connect Apache Druid to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
