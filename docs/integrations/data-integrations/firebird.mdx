...
This is the implementation of the Firebird data handler for KozmoDB.
...
2. To connect Firebird to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the Firebird server in KozmoDB, the following syntax can be used:
...
WITH
    ...
    parameters = {
        "host": "localhost",
        "database": "C:\Users\minura\Documents\kozmodb\example.fdb",
        "user": "sysdba",
        "password": "password"
    };
```
