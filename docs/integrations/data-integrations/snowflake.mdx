...
When querying data from Snowflake, KozmoDB automatically converts column names to lower-case. To prevent this, users can provide an alias name as shown below.

**This update is introduced with the KozmoDB version 25.3.4.1. It is not backward-compatible and has the following implications:**
...
The below query presents how Snowflake columns are output when queried from KozmoDB.
