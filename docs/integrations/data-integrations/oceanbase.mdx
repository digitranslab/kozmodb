...
This is the implementation of the OceanBase data handler for KozmoDB.
...
2. To connect OceanBase to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the OceanBase server in KozmoDB, the following syntax can be used:
