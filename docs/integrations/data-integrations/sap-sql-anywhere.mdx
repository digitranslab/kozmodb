...
This is the implementation of the SAP SQL Anywhere data handler for KozmoDB.
...
2. To connect SAP SQL Anywhere to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
