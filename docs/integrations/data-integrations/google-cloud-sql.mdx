...
This is the implementation of the Google Cloud SQL data handler for KozmoDB.
...
2. To connect Google Cloud SQL to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
If you are using KozmoDB cloud version you can use the following IP address: `
18.220.205.95
3.19.152.46
52.14.91.162
`
