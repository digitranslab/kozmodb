...
This is the implementation of the Trino data handler for KozmoDB.
...
2. To connect Trino to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
In order to make use of this handler and connect to the Trino database in KozmoDB, the following syntax can be used:
