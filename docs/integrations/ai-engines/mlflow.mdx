...
## How to Use MLflow Models in KozmoDB

Here are the prerequisites for using MLflow-served models in KozmoDB:
...
```sql
CREATE MODEL kozmodb.mlflow_model
PREDICT target
USING
    engine = 'mlflow',
...
FROM kozmodb.mlflow_model AS m
