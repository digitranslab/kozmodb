...
WHERE document = 'KozmoDB is a predictive platform that connects machine learning models with databases.';
...
WHERE text = 'Kozmo , 35, lives in New York and works as a software engineer.';
