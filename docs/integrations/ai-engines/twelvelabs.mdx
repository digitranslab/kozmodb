...
In this section, we present how to connect Twelve Labs API to KozmoDB.
...
Before proceeding, ensure the following prerequisites are met:
 ...
 2. To use Twelve Labs with KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
