...
Create an AI engine from the [Anomaly Detection handler](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/anomaly_detection_handler).
...
To run example queries, use the data from this [CSV file](https://raw.githubusercontent.com/digitranslab/kozmodb/main/tests/unit/ml_handlers/data/anomaly_detection.csv).
