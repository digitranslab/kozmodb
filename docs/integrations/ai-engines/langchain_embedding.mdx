...
Create an [AI/ML engine](/kozmodb_sql/sql/create/ml-engine) from the [LangChain Embedding handler](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/langchain_embedding_handler).
