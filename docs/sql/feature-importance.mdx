---
title: Feature Importance of KozmoDB and Lightwood
sidebarTitle: Feature Importance
---

KozmoDB together with the Lightwood ML engine provide the feature importance tool.
...
You can customize the behavior of this analysis module from the KozmoDB SQL editor via the USING key. For example, if you want to consider all rows in the validation dataset, rather than clip it to some default value, here is an example:
...
Check out the article on [Model agnostic confidence estimation with conformal predictors for AutoML](https://medium.com/kozmodb/model-agnostic-confidence-estimation-with-conformal-predictors-for-automl-55fce87ef42a) by [Patricio Cerda Mardini](https://medium.com/@paxcema)
to learn how KozmoDB estimates confidence.
</Tip>
