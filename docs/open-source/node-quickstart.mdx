...
To install Kozmodb, you can use npm. Run the following command in your terminal:
...
Kozmodb TypeScript SDK support history stores to run on a serverless environment:
...
Kozmodb uses SQLite as a default history store.
...
| Parameter         | Description                          | Default                    |
|------------------|--------------------------------------|----------------------------|
| `historyDbPath` | Path to the history database         | "{kozmodb_dir}/history.db"    |
