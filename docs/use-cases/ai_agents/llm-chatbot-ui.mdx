---
title: Build a No-Code Chatbot with KozmoDB
sidebarTitle: Chatbot Interface
---

KozmoDB enables you to build a chatbot, train it using your data, and integrate it into a chat application. All of this can be achieved through a user-friendly interface that doesn't require coding.

This guide will walk you through the process of building and training a chatbot using KozmoDB's LLM UI.
