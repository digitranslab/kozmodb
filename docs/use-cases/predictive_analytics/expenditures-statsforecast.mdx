---
title: Forecast Monthly Expenditures with Nixtla's StatsForecast and KozmoDB
...
We use a table from our MySQL public demo database, so let’s start by connecting it to KozmoDB.
