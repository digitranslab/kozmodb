...
<Note>
This tutorial uses the Lightwood integration that requires the `kozmodb/kozmodb:lightwood` Docker image. [Learn more here](/setup/self-hosted/docker#install-kozmodb).
</Note>
