...
<Tip>
You can build a Twitter chatbot that converts text prompts into images. Follow [this blog post](https://kozmodb.com/blog/tutorial-how-to-add-ai-image-generation-to-your-own-app) to see the total workflow.
</Tip>

## Creating a Model

Let's create an OpenAI model. Follow [this instruction](/integrations/ai-engines/openai#setup) to set up the OpenAI integration in KozmoDB.
...
<Tip>
Check out how to implement a Twitter chatbot that answers by generating images. Follow [this link](https://kozmodb.com/blog/tutorial-how-to-add-ai-image-generation-to-your-own-app) to learn more.
</Tip>
