...
bigquery_config = DatabaseConfig(
    ...
    connection_data={
        ...
        'service_account_json': {
                ...
                'client_email': 'kozmodb-app@expanded-pride-394015.iam.gserviceaccount.com',
                'client_id': '1234...8123',
                'auth_uri': 'https://accounts.google.com/o/oauth2/auth',
                'token_uri': 'https://oauth2.googleapis.com/token',
                'auth_provider_x509_cert_url': 'https://www.googleapis.com/oauth2/v1/certs',
                'client_x509_cert_url': 'https://www.googleapis.com/robot/v1/metadata/x509/kozmodb-app%40expanded-pride-394015.iam.gserviceaccount.com',
...
Note that the above connection parameters connect to the [sample database provided by KozmoDB](/kozmo/sample_data_sources).
