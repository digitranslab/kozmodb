...
<Tip>
Learn more about features of [knowledge bases available via SQL API](/kozmodb_sql/knowledge_bases/overview).
</Tip>
...
<Tip>
See more examples of [knowledge bases via SQL here](/kozmodb_sql/knowledge_bases/overview).
</Tip>
