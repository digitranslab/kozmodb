...
The `query()` function is executed on a data source connected to KozmoDB and saved into a variable. It queries a table from this data source.
...
You can query for newly added data using the functionality introduced by the [`LAST` keyword](/kozmodb_sql/sql/create/jobs#last) as follows:
