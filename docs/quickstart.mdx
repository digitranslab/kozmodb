...
<Note type="info">
🎉 We're excited to announce that Claude 4 is now available with Kozmodb! Check it out [here](components/llms/models/anthropic).
</Note>


Kozmodb offers two powerful ways to leverage our technology: [our managed platform](#kozmodb-platform-managed-solution) and [our open source solution](#kozmodb-open-source).

Check out our [Playground](https://kozmodb.dev/pd-pg) to see Kozmodb in action.

<CardGroup cols={2}>
  <Card title="Kozmodb Platform (Managed Solution)" icon="chart-simple" href="#kozmodb-platform-managed-solution">
    Better, faster, fully managed, and hassle free solution.
  </Card>
  <Card title="Kozmodb Open Source" icon="code-branch" href="#kozmodb-open-source">
    Self hosted, fully customizable, and open source.
  </Card>
</CardGroup>


## Kozmodb Platform (Managed Solution)

Our fully managed platform provides a hassle-free way to integrate Kozmodb's capabilities into your AI agents and assistants. Sign up for Kozmodb platform [here](https://kozmodb.dev/pd).

The Kozmodb SDK supports both Python and JavaScript, with full [TypeScript](/platform/quickstart/#4-11-working-with-kozmodb-in-typescript) support as well.

Follow the steps below to get started with Kozmodb Platform:

1. [Install Kozmodb](#1-install-kozmodb)
...
<Card title="Kozmodb Platform" icon="chart-simple" href="/platform/overview">
  Learn more about Kozmodb platform
</Card>

## Kozmodb Open Source

Our open-source version is available for those who prefer full control and customization. You can self-host Kozmodb on your infrastructure and integrate it with your AI agents and assistants. Checkout our [GitHub repository](https://kozmodb.dev/gd)

Follow the steps below to get started with Kozmodb Open Source:

1. [Install Kozmodb Open Source](#1-install-kozmodb-open-source)
2. [Add Memories](#2-add-memories-open-source)
3. [Retrieve Memories](#3-retrieve-memories-open-source)

### 1. Install Kozmodb Open Source
...
<CardGroup cols={2}>
<Card title="Kozmodb OSS Python SDK" icon="python" href="/open-source/python-quickstart">
  Learn more about Kozmodb OSS Python SDK
</Card>
<Card title="Kozmodb OSS Node.js SDK" icon="node" href="/open-source-typescript/quickstart">
  Learn more about Kozmodb OSS Node.js SDK
</Card>
</CardGroup>