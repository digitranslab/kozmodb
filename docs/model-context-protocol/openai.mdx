---
title: KozmoDB's MCP Server with OpenAI's Remote MCP
sidebarTitle: OpenAI
---

This tutorial walks you through the usage of KozmoDB's MCP Server with [OpenAI's Remote MCP](https://platform.openai.com/docs/guides/tools-remote-mcp).

## Setup

Follow the steps below to connect KozmoDB's MCP Server to OpenAI.
...
Here is how to connect KozmoDB's MCP Server to OpenAI.
    ...
    tools = [
        {
            ...
            "headers": { "Authorization": "Bearer <YOUR_KOZMODB_TOKEN>" },
