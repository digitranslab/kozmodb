---
title: Naming Standards for KozmoDB Objects
sidebarTitle: KozmoDB Objects
icon: "puzzle-piece-simple"
---

KozmoDB allows you to create and manage a variety of entities within its ecosystem. All KozmoDB objects follow the same naming conventions to ensure consistency and compatibility across the platform.

## KozmoDB Entities

The following entities can be created in KozmoDB:

* Databases → [CREATE DATABASE](https://docs.kozmodb.com/kozmodb_sql/sql/create/database)

* Knowledge Bases (KBs) → [CREATE KNOWLEDGE_BASE](https://docs.kozmodb.com/kozmodb_sql/knowledge_bases/create)

* Tables → [CREATE TABLE](https://docs.kozmodb.com/kozmodb_sql/sql/create/table)

* Views → [CREATE VIEW](https://docs.kozmodb.com/kozmodb_sql/sql/create/view)

* Projects → [CREATE PROJECT](https://docs.kozmodb.com/kozmodb_sql/sql/create/project)

* Jobs → [CREATE JOB](https://docs.kozmodb.com/kozmodb_sql/sql/create/jobs)

* Triggers → [CREATE TRIGGER](https://docs.kozmodb.com/kozmodb_sql/sql/create/trigger)

* Agents → [CREATE AGENT](https://docs.kozmodb.com/kozmodb_sql/agents/agent_syntax)
...
<Warning>
When working with entities from a data source connected to KozmoDB, their original names are preserved and are not subject to KozmoDB naming rules.
