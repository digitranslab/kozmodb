...
<Tip>
Learn more about knowledge bases following [this doc page](/kozmodb_sql/knowledge_bases/overview).
</Tip>

### Path Parameters

<ParamField body='project_name' type='string' required>
Defines the project where the knowledge bases are located. Note that the default project name is `kozmodb`.
</ParamField>
...
Defines the list of URLs to be crawled and their content inserted into the knowledge base. For example, `"urls": ["https://docs.kozmodb.com/kozmodb_sql/knowledge_bases/overview"]`.
</ParamField>
...
```shell Shell
curl -X PUT http://127.0.0.1:47334/api/projects/kozmodb/knowledge_bases/my_kb \
