...
```shell Shell
curl --request PUT \
  --url http://127.0.0.1:47334/api/projects/kozmodb/agents/my_agent \
...
```json Response
{
  ...
  "prompt_template": "my_project.my_kb stores documentation of KozmoDB, my_data_source.my_table stores documentation of KozmoDB"
}
```
