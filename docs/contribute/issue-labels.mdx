...
In this section, we go through all issue labels available in the [KozmoDB GitHub repository](https://github.com/digitranslab/kozmodb).
...
If you haven't contributed to KozmoDB before, you can search for the issues marked as <code><font color='#9F1260'>first-timers-only</font></code> to get started.

Please note that before we can accept your contribution to KozmoDB, we ask you to sign our [Contributor License Agreement](https://github.com/digitranslab/kozmodb/blob/main/assets/contributions-agreement/individual-contributor.md).

You can find all the <code><font color='#9F1260'>first-timers-only</font></code> issues [here](https://github.com/digitranslab/kozmodb/labels/first-timers-only).
...
You can find all the <code><font color='#7057FF'>good first issue</font></code> issues [here](https://github.com/digitranslab/kozmodb/labels/good%20first%20issue).
...
You can find all the <code><font color='#0E8A16'>hactoberfest</font></code> issues [here](https://github.com/digitranslab/kozmodb/labels/hacktoberfest).

### The <font color='#008672'>`help wanted`</font> Label

Issues marked as <code><font color='#008672'>help wanted</font></code> are for anybody who wants to contribute to KozmoDB.

You can find all the <code><font color='#008672'>help wanted</font></code> issues [here](https://github.com/digitranslab/kozmodb/labels/help%20wanted).

### The <font color='#D8ED79'>`integration`</font> Label

The <code><font color='#D8ED79'>integration</font></code> label marks issues that require a contributor to implement a database or ML integration with KozmoDB. If you take up such an issue, you can participate in the Integration Contest of KozmoDB.
...
You can find all the <code><font color='#D8ED79'>integration</font></code> issues [here](https://github.com/digitranslab/kozmodb/labels/integration).

## Other Labels

Here are other labels used in the KozmoDB repository.
...
As KozmoDB grows day by day, there are still things that require improvements. All issues suggesting enhancements to KozmoDB are marked as <code><font color='#A2EEEF'>enhancement</font></code>.
