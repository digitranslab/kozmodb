...
This section presents how to write a tutorial with KozmoDB.
...
The tutorial should be a Markdown file, for example, `kozmodb-tutorial.mdx`. Here is the [basic Markdown syntax](https://www.markdownguide.org/basic-syntax/).
</Info>
...
data from and how to connect it to KozmoDB.
