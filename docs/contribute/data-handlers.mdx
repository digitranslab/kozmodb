...
In this section, you'll find how to add new integrations/databases to KozmoDB.
...
Database handlers act as a bridge to any database. You use database handlers to create databases using [the CREATE DATABASE command](/sql/create/databases/). So you can reach data from any database that has its handler implemented within KozmoDB.

## Creating a Database Handler

You can create your own database handler within KozmoDB by inheriting from the [`DatabaseHandler`](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/libs/base.py#L102) class.
...
<Tip>
    **Other Common Methods**
    ...
    Also, there are wrapper classes for the `DatabaseHandler` instances called [HandlerResponse](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/libs/response.py#L7) and [HandlerStatusResponse](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/libs/response.py#L32). You should use them to ensure proper output formatting.
</Tip>

### Implementation

Each database handler should inherit from the [`DatabaseHandler`](https://github.com/digitranslab/kozmodb/blob/main/kozmodb/integrations/libs/base.py#L102) class.

Here is a step-by-step guide:

* Setting the `name` class property:

    KozmoDB uses it internally as the name of the handler.
...
Here is an example of the `connection_args.py` file from the [MySQL handler](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/mysql_handler) where the password value is set to hidden with `'secret': True`.
...
Here is an example of the `__init__.py` file for the [MySQL handler](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/mysql_handler).
...
The `__about__.py` file for the same [MySQL handler](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/mysql_handler) contains the following variables:
...
* [MySQL](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/mysql_handler)
* [Postgres](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/postgres_handler)
