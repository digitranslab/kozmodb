...
If you want to report a bug, request a feature, suggest docs improvements, or propose a new integration, you can do that on the [KozmoDB GitHub issues page](https://github.com/digitranslab/kozmodb/issues).

But before reporting a new issue, please make sure that it is not already there.

## How to Create an Issue

Here is how to get started when you want to create an issue in the KozmoDB repository.

Go to [our GitHub issues page](https://github.com/digitranslab/kozmodb/issues)
...
<Info>
  ...
  guidelines](https://github.com/digitranslab/kozmodb/blob/main/CONTRIBUTING.md)
  and [code of
  conduct](https://github.com/digitranslab/kozmodb/blob/main/CODE_OF_CONDUCT.md).
</Info>

Thank you for reporting a bug! It helps us improve KozmoDB for you and future
users.
...
Thank you for submitting a feature request! It helps us improve KozmoDB for you
and future users.
...
Thank you for suggesting docs enhancements! It helps us improve KozmoDB for you
and future users.
...
Thank you for proposing a new integration! It helps us improve KozmoDB for you
and future users.
...
Thank you for reporting a security vulnerability! It helps us improve KozmoDB for you
and future users.
