---
title: How to Write KozmoDB Documentation
sidebarTitle: Write Documentation
icon: "pen"
---

This section gets you started on how to contribute to the KozmoDB documentation.

KozmoDB's documentation is run using Mintlify. If you want to contribute to our docs, please follow the steps below to set up the environment locally.
...
Step 1. Clone the KozmoDB Git repository:
...
Step 3. Go to the `docs` folder inside the cloned KozmoDB Git repository and start Mintlify there:
...
## KozmoDB Repository Structure

Here is the structure of the KozmoDB docs repository:
...
Thank you for contributing to the KozmoDB docs!
