...
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `project_name`                                  | Name of the project where the model is created. By default, the `kozmodb` project is used.                                                      |
...
| `tag_name`                                      | You can optionally provide a tag that is visible in the `training_options` column of the `kozmodb.models` table.                                |
...
Here is the syntax for using external models within KozmoDB:
...
It allows you to bring an external model, for example, from the Hugging Face model hub, and use it within KozmoDB.

### Large Language Models (LLM)

KozmoDB integrates with [numerous LLM providers listed here](/integrations/ai-overview#large-language-models).
...
Visit our [page no how to bring Hugging Face models into KozmoDB](/custom-model/huggingface/) for more details.
...
<Tip>
    **Checking Model Status**
    ...
    After you run the `CREATE MODEL` statement, you can check the status of the training process by querying the `kozmodb.models` table.
