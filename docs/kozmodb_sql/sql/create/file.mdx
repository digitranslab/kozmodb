...
Follow the steps below to upload a file to KozmoDB.
...
This command is the same as the command for listing tables because files uploaded to KozmoDB become tables within the KozmoDB ecosystem and are stored in the `files` database.
