...
KozmoDB provides two ways of using the `UPDATE` statement:
...
And here is an example of the `UPDATE FROM SELECT` statement that updates a table with predictions made within KozmoDB:
