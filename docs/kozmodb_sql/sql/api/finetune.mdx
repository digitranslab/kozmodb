...
| `WHERE incremental_column > LAST`           | Selecting only newly added data to be used to finetune the model. Learn more about the [`LAST` keyword here](/kozmodb_sql/sql/create/jobs#last). |
