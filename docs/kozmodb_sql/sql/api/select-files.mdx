...
First, you upload a file to the KozmoDB Editor by following
...
| Name          | Description                                                                                   |
| ------------- | --------------------------------------------------------------------------------------------- |
| `file_name`   | Name of the file uploaded to the KozmoDB Editor by following [this guide](/sql/create/file/). |
