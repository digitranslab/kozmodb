...
KozmoDB supports standard SQL functions via DuckDB and MySQL engines.

## DuckDB Functions

KozmoDB executes functions on the underlying DuckDB engine. Therefore, [all DuckDB functions](https://duckdb.org/docs/stable/sql/functions/overview) are supported within KozmoDB out of the box.
...
KozmoDB executes MySQL-style functions on the underlying DuckDB engine. The following functions have been adapted to MySQL-style functions.
