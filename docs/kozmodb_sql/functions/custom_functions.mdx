...
Custom functions provide advanced means of manipulating data. Users can upload custom functions written in Python to KozmoDB and apply them to data.

## How It Works

You can upload your custom functions via the KozmoDB editor by clicking `Add` and `Upload custom functions`, like this:

<p align="center">
  <img src="/assets/upload_custom_function.png" />
</p>

Here is the form that needs to be filled out in order to bring your custom functions to KozmoDB:
