...
Please follow the instructions below to connect your KozmoDB to SQL Alchemy.

<Tabs>
        <Tab title="Local KozmoDB">
        You can use the Python code below to connect your KozmoDB database to SQL Alchemy.
        ...
        ```bash
        Connection to the 127.0.0.1 for user kozmodb created successfully.
        ```
