---
title: KozmoDB and Jupyter Notebooks
...
<Tip>
You can consider an option to interact with KozmoDB directly from [MySQL CLI](/connect/mysql-client/) or [Postgres CLI](/connect/postgres-client/).
</Tip>
...
Please follow the instructions below to connect to your KozmoDB via Jupysql and Jupyter.

<Tabs>
        <Tab title="Local KozmoDB">
        You can use the Python code below to connect your Jupyter notebook (or lab) to Local KozmoDB database (via Jupysql).
        Load the extension:
        ...
        ```python
        %sql mysql+pymysql://kozmodb:@127.0.0.1:47335/kozmodb
        ```
...
```bash
*  mysql+pymysql://kozmodb:***@127.0.0.1:47335/kozmodb
2 rows affected.
Tables_in_kozmodb
models
```
