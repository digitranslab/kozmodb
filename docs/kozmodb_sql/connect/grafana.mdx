...
<Tabs>
  <Tab title="Local KozmoDB">
    You can connect to your local KozmoDB. To do that, please use the connection details below:
...
allows you to connect to KozmoDB.
...
To verify the functionality of our KozmoDB database connection,
...
Now you can build a dashboard with a KozmoDB database connection.
Example query :
