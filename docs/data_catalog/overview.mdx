...
The **Data Catalog** in KozmoDB plays a key role in enhancing the context available to [agents](/kozmodb_sql/agents/agent) when querying data sources. By automatically indexing and storing metadata, such as table names, column types, constraints, and statistics, the catalog empowers agents to understand the structure and semantics of the data, leading to more accurate and efficient query generation.
