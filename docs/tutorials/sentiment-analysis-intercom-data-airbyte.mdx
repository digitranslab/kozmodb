...
Now you can connect the Google BigQuery database that stores the Intercom data to KozmoDB.
...
Follow [this instruction](https://docs.kozmodb.com/data-integrations/google-bigquery) to connect your database to KozmoDB.
...
Now we join our data table (joined_conversations) that stores Intercom conversations with the model (sentiment_classifier_model) created in KozmoDB. That's how we can make batch predictions for all conversations at once.
...
Run it in the KozmoDB editor to find out the output.

## What's Next?

Want to learn more about KozmoDB? Check out these resources:

- [KozmoDB](https://kozmodb.com/)
- [KozmoDB Documentation](https://docs.kozmodb.com/)
- [Slack](https://kozmodb.com/joincommunity)
- [GitHub](https://github.com/digitranslab/kozmodb/)
