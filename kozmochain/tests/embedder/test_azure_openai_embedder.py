...
from kozmochain.embedder.azure_openai import AzureOpenAIEmbedder
...
def test_azure_openai_embedder_with_http_client(monkeypatch):
    ...
    with patch("kozmochain.embedder.azure_openai.AzureOpenAIEmbeddings") as mock_embeddings, patch(
