...
from kozmochain.config import AppConfig, ChromaDbConfig
from kozmochain.kozmochain import KozmoChain
from kozmochain.llm.base import BaseLlm
from kozmochain.memory.base import ChatHistory
...
def test_whole_app(app_instance, mocker):
    ...
    mocker.patch.object(KozmoChain, "add")
    mocker.patch.object(KozmoChain, "_retrieve_from_database")
...
def test_add_after_reset(app_instance, mocker):
    mocker.patch("kozmochain.vectordb.chroma.chromadb.Client")
