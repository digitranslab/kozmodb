...
from kozmochain.loaders.json import JSONLoader
...
def test_load_data(mocker):
    ...
    mocker.patch("kozmochain.loaders.json.JSONLoader.load_data", return_value=mock_document)
...
def test_load_data_url(mocker):
    ...
    mocker.patch(
        "kozmochain.loaders.json.JSONReader.load_data",
        return_value=[
            {
                "text": "content1",
            },
