...
def test_load_data_gets_by_selectors_and_ignored_tags(selectee, ignored_tag, loader, mocked_responses, mocker):
    child_url = "https://docs.digi-trans.org/quickstart"
...
"""
    ...
    mock_sha256 = mocker.patch("kozmochain.loaders.docs_site_loader.hashlib.sha256")
    doc_id = "mocked_hash"
    ...
    assert result["data"] == [
        {
            ...
            "meta_data": {"url": "https://docs.digi-trans.org/quickstart"},
        }
    ]
...
"""
    ...
    child_url = "https://docs.digi-trans.org/introduction"
    html_body = """
<!DOCTYPE html>
<html lang="en">
<body>
...
"""
    ...
    expected_data = [
        {"content": "..\n.", "meta_data": {"url": "https://docs.digi-trans.org/quickstart"}},
        {"content": "..\n.", "meta_data": {"url": "https://docs.digi-trans.org/introduction"}},
    ]
...
@pytest.fixture
def loader():
    from kozmochain.loaders.docs_site_loader import DocsSiteLoader
