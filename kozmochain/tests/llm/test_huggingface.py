...
from kozmochain.llm.huggingface import HuggingFaceLlm
...
def test_get_llm_model_answer(huggingface_llm_config, mocker):
    mocker.patch("kozmochain.llm.huggingface.HuggingFaceLlm._get_answer", return_value="Test answer")
...
def test_hugging_face_mock(huggingface_llm_config, mocker):
    ...
    mock_hf_hub = mocker.patch("kozmochain.llm.huggingface.HuggingFaceHub")
...
def test_custom_endpoint(huggingface_endpoint_config, mocker):
    mock_llm_instance = mocker.Mock(return_value="Test answer")
    mock_hf_endpoint = mocker.patch("kozmochain.llm.huggingface.HuggingFaceEndpoint")
