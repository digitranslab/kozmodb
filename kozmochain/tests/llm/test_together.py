...
from kozmochain.llm.together import TogetherLlm
...
def test_get_llm_model_answer(together_llm_config, mocker):
    mocker.patch("kozmochain.llm.together.TogetherLlm._get_answer", return_value="Test answer")
...
def test_get_llm_model_answer_with_token_usage(together_llm_config, mocker):
    ...
    mocker.patch(
        "kozmochain.llm.together.TogetherLlm._get_answer",
...
def test_get_answer_mocked_together(together_llm_config, mocker):
    mocked_together = mocker.patch("kozmochain.llm.together.ChatTogether")
