...
from kozmochain.llm.cohere import CohereLlm
...
def test_get_llm_model_answer(cohere_llm_config, mocker):
    mocker.patch("kozmochain.llm.cohere.CohereLlm._get_answer", return_value="Test answer")
...
def test_get_llm_model_answer_with_token_usage(cohere_llm_config, mocker):
    ...
    mocker.patch(
        "kozmochain.llm.cohere.CohereLlm._get_answer",
...
def test_get_answer_mocked_cohere(cohere_llm_config, mocker):
    mocked_cohere = mocker.patch("kozmochain.llm.cohere.ChatCohere")
