...
from kozmochain.config import ZillizDBConfig
from kozmochain.vectordb.zilliz import ZillizVectorDB
...
class TestZillizVectorDB:
    ...
    @patch("kozmochain.vectordb.zilliz.MilvusClient", autospec=True)
    @patch("kozmochain.vectordb.zilliz.connections.connect", autospec=True)
...
class TestZillizDBCollection:
    ...
    def test_init_with_default_collection(self):
        ...
        assert db_config.collection_name == "kozmochain_store"
    ...
    @patch("kozmochain.vectordb.zilliz.MilvusClient", autospec=True)
    @patch("kozmochain.vectordb.zilliz.connections", autospec=True)
