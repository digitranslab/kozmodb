...
from kozmochain.vectordb.pinecone import PineconeDB
...
def test_pinecone_init_without_config(monkeypatch):
    ...
    monkeypatch.setattr("kozmochain.vectordb.pinecone.PineconeDB._setup_pinecone_index", lambda x: x)
    monkeypatch.setattr("kozmochain.vectordb.pinecone.PineconeDB._get_or_create_db", lambda x: x)
...
def test_setup_pinecone_index(pinecone_pod_config, pinecone_serverless_config, monkeypatch):
    monkeypatch.setattr("kozmochain.vectordb.pinecone.pinecone", MockPinecone)
    monkeypatch.setenv("PINECONE_API_KEY", "test_api_key")
    pinecone_db = PineconeDB(config=pinecone_pod_config)
