...
from kozmochain.config import AppConfig, ElasticsearchDBConfig
from kozmochain.embedder.gpt4all import GPT4AllEmbedder
from kozmochain.vectordb.elasticsearch import ElasticsearchDB


class TestEsDB(unittest.TestCase):
    @patch("kozmochain.vectordb.elasticsearch.Elasticsearch")
