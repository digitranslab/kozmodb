...
🚀 An <a href="https://github.com/digitranslab/kozmochain">Kozmochain</a> app powered with Unacademy\'s UPSC data!
</p>
"""
...
with st.expander(":grey[Want to create your own Unacademy UPSC AI?]"):
    ...
    For more information, checkout the [Kozmochain docs](https://docs.digi-trans.org/get-started/quickstart).
    """
    )
