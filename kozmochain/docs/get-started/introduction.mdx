...
Kozmochain is an Open Source Framework that makes it easy to create and deploy personalized AI apps. At its core, Kozmochain follows the design principle of being *"Conventional but Configurable"* to serve both software engineers and machine learning engineers.
...
When a user asks a question, whether for chatting, searching, or querying, Kozmochain simplifies the response process:
...
With Kozmochain, you don’t have to worry about the complexities of building a personalized AI application. It offers an easy-to-use interface for developing applications with any kind of data.
...
- [GitHub](https://github.com/digitranslab/kozmochain)
