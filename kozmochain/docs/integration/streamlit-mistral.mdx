...
In this example, we will learn how to use `mistralai/Mixtral-8x7B-Instruct-v0.1` and Kozmochain together with Streamlit to build a simple RAG chatbot.

![Streamlit + Kozmochain Demo](https://github.com/digitranslab/kozmochain/assets/73601258/052f7378-797c-41cf-ac81-f004d0d44dd1)

## Setup

Install Kozmochain and Streamlit.
```bash
pip install kozmochain streamlit
```
<Tabs>
    <Tab title="app.py">
    ```python
