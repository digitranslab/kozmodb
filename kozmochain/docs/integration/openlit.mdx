...
Kozmochain now supports integration with [OpenLIT](https://github.com/openlit/openlit).
...
Now create an app using Kozmochain and initialize OpenTelemetry monitoring
