...
Kozmochain provides the right set of tools to create chatbots for the above use cases. Refer to the following examples of chatbots on and you can built on top of these examples:
...
<CardGroup cols={2}>
  ...
  <Card title="Custom GPT Creation" href="https://app.digi-trans.org/create-your-gpt/" target="_blank" icon="link">
