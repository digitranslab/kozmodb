Fork the Kozmochain repo on [Github](https://github.com/digitranslab/kozmochain) to create your own NextJS discord and slack bot powered by Kozmochain.
...
- We will use [Fly.io](https://fly.io/) to deploy our kozmochain app, discord and slack bot. Follow the step one to install [Fly.io CLI](https://docs.digi-trans.org/deployment/fly_io#step-1-install-flyctl-command-line)

# Developement

## Kozmochain App

First, we need an Kozmochain app powered with the knowledge of NextJS. We have already created an kozmochain app using FastAPI in `ec_app` folder for you. Feel free to ingest data of your choice to power the App.
