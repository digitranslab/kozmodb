[Kozmochain Examples Repo](https://github.com/digitranslab/examples) contains code on how to build your own Slack AI to chat with the unstructured data lying in your slack channels.
...
This demo was built using the Kozmochain's [full stack demo template](https://docs.digi-trans.org/get-started/full-stack). Follow the instructions [given here](https://docs.digi-trans.org/get-started/full-stack) to create your own full stack RAG application.
