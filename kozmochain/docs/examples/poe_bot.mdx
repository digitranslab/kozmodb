...
1. Install kozmochain python package:

```bash
pip install fastapi-poe==0.0.16 
```

2. Create a free account on [Poe](https://www.poe.com?utm_source=kozmochain).
...
from kozmochain.bots import PoeBot
...
11. You can refer the [Supported Data formats](https://docs.digi-trans.org/advanced/data_types) section to refer the supported data types in kozmochain.
