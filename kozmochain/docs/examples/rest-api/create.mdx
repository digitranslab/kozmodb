...
To learn more about custom configurations, check out the [custom configurations docs](https://docs.digi-trans.org/advanced/configuration). To explore more examples of config yamls for kozmochain, visit [kozmochain/configs](https://github.com/digitranslab/kozmochain/tree/main/configs).
...
```bash
docker run --name kozmochain -p 8080:8080 -e OPENAI_API_KEY=<YOUR_OPENAI_API_KEY> kozmochain/rest-api:latest
```