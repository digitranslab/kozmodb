...
To use Kozmochain as a REST API service, run the following command:

```bash
docker run --name kozmochain -p 8080:8080 kozmochain/rest-api:latest
```
...
![Swagger Docs Screenshot](https://github.com/digitranslab/kozmochain/assets/73601258/299d81e5-a0df-407c-afc2-6fa2c4286844)
...
<Steps>
  ...
  <Step title="🚀 (Optional) Deploy your app to Kozmochain Platform">
    <Tabs>
      <Tab title="cURL">
        ```bash
        curl --request POST \
