...
<Tabs>
    <Tab title="docker">
        ```bash
        docker run --name telegram-bot -e OPENAI_API_KEY=sk-xxx -e TELEGRAM_BOT_TOKEN=xxx -p 8000:8000 kozmochain/telegram-bot
        ```
    ...
    <Tab title="replit">
    <Card>
        Fork <ins>**[this](https://replit.com/@mobenchio/EC-Telegram-Bot-Template?v=1#README.md)**</ins> replit template.
    </Card>
