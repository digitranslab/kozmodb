...
Here is an example of how you can do hybrid search using Pinecone as a vector database through Kozmochain.
...
Under the hood, Kozmochain fetches the relevant chunks from the documents you added by doing hybrid search on the pinecone index.
