...
## Pre-requisite
- Download required packages by running `pip install --upgrade "kozmochain[slack]"`.
...
# Answer: The available bot in the slack workspace's random channel is the Kozmochain bot.
```
