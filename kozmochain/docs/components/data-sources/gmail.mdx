...
To use GmailLoader you must install the extra dependencies with `pip install --upgrade kozmochain[gmail]`.
...
8. Choose the application type `Web application`. As a name you can choose `kozmochain` or any other name as per your use case.
