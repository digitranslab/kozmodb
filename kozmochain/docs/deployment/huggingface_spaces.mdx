...
With Kozmochain, you can directly host your apps in just three steps to huggingface spaces where you can view and deploy your app to the world.
...
This will also create an `kozmochain.json` file in your app directory. Add a `name` key into the `kozmochain.json` file. This will be the "repo-name" of your app in huggingface spaces.

```json kozmochain.json
{
    "name": "my-rag-app",
