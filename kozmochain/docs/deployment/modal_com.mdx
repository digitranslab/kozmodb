...
Kozmochain has a nice and simple abstraction on top of the [Modal.com](https://modal.com/) tools to let developers deploy RAG application to modal.com platform seamlessly.
...
We provide a command line utility called `ec` in kozmochain that inherits the template for `modal.com` platform and help you deploy the app. Follow the instructions to create a modal.com app using the template provided:


```bash Create application
pip install kozmochain[modal]
mkdir my-rag-app
