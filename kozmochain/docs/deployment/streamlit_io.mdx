...
Kozmochain offers a Streamlit template to facilitate the development of RAG chatbot applications in just three easy steps.

Follow the instructions given below to deploy your first application quickly:

## Step-1: Create RAG app

We provide a command line utility called `ec` in kozmochain that inherits the template for `streamlit.io` platform and help you deploy the app. Follow the instructions to create a streamlit.io app using the template provided:

```bash Install kozmochain
...
- `kozmochain.json`: Contains kozmochain specific configuration for deployment (you don't need to configure this)
...
![Streamlit App deploy button](https://github.com/digitranslab/kozmochain/assets/73601258/90658e28-29e5-4ceb-9659-37ff8b861a29)
