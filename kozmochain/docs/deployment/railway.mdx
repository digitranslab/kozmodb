...
It's easy to host your Kozmochain-powered apps and APIs on railway.
...
<Tip>
**Create a full stack app using Kozmochain CLI**

To use your hosted kozmochain RAG app, you can easily set up a FastAPI server that can be used anywhere.
To easily set up a FastAPI server, check out [Get started with Full stack](https://docs.digi-trans.org/get-started/full-stack) page.
...
By default, Railway uses Python 3.7. Kozmochain requires the python version to be >3.9 in order to install.
