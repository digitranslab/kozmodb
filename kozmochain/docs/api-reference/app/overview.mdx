...
Create a RAG app object on Kozmochain. This is the main entrypoint for a developer to interact with Kozmochain APIs. An app configures the llm, vector database, embedding model, and retrieval strategy of your choice.
...
<ParamField path="client" type="Client" optional>
    Client object (used to deploy an app to Kozmochain platform)
</ParamField>
