...
<ParamField path="all_references" type="bool" optional>
    This parameter instructs Kozmochain to retrieve all the context and information from the specified link, as well as from any reference links on the page.
</ParamField>
