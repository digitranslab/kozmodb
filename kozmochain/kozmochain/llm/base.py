...
class BaseLlm(JSONSerializable):
    def __init__(self, config: Optional[BaseLlmConfig] = None):
        ...
        # the llm memory
        setup_engine(database_uri=os.environ.get("KOZMOCHAIN_DB_URI", f"sqlite:///{SQLITE_PATH}"))
        init_db()
