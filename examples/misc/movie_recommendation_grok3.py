"""
Memory-Powered Movie Recommendation Assistant (Grok 3 + Kozmodb)
This script builds a personalized movie recommender that remembers your preferences
(e.g. dislikes horror, loves romcoms) using Kozmodb as a memory layer and Grok 3 for responses.

In order to run this file, you need to set up your Kozmodb API at Kozmodb platform and also need an XAI API key.
...
# Configure Kozmodb with Grok 3 and Qdrant
config = {
