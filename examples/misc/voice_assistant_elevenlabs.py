"""
Personal Voice Assistant with Memory (Whisper + CrewAI + Kozmodb + ElevenLabs)
...
- Remember user preferences and facts using Kozmodb memory
...
- Python packages: openai, elevenlabs, crewai, kozmodb, pyaudio
"""
...
from kozmodb import MemoryClient
...
def get_agent_response(user_input):
    ...
    try:
        ...
        crew = Crew(
            ...
            verbose=True,
            memory=True,
            memory_config={"provider": "kozmodb", "config": {"user_id": USER_ID}},
        )
        result = crew.kickoff()
...
# ------------------ MAIN LOOP ------------------
def run_voice_agent():
    print("🧠 Voice agent (Whisper + Kozmodb + ElevenLabs) is ready! Say something.")
    while True:
