...
# Project information
# ----------------- #
sys.path.append(os.path.abspath('../../kozmodb_evaluator'))

# ----------------- #
# Project information
# ----------------- #
project = 'kozmodb_evaluator'
copyright = '2023, KozmoDB'
authors = "KozmoDB"
now = datetime.datetime.now()

# Version of the package
packageversion = __import__('kozmodb_evaluator').__version__
...
# Brand logo
html_logo = "_static/logos/kozmodblogo.png"
...
autoapi_dirs = ['../../kozmodb_evaluator']
