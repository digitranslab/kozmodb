...
query = parse_sql('select b from aaa where c=1', dialect='kozmodb')
...
kozmodb
- Extended mysql dialect with support of kozmodb sql commands and operators [https://docs.kozmodb.com/]
...
Example:
![image](https://github.com/digitranslab/kozmodb_sql/assets/8502631/c4707087-ca6e-47f6-aaba-db3a641947a6)
...
```python
from kozmodb_sql.planner import query_planner

# all parameters are optional
planner = query_planner.QueryPlanner(
    ast_query, # query as AST-tree
    integrations=['mysql'], # list of available integrations
    predictor_namespace='kozmodb', # name of namespace to lookup for predictors
    default_namespace='kozmodb', # if namespace is not set in query default namespace will be used
...
```
Detailed description of timeseries predictor: [https://docs.kozmodb.com/sql/create/predictor/]
...
```python
from kozmodb_sql.render.sqlalchemy_render import SqlalchemyRender
