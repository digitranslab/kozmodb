...
from kozmodb_sql import parse_sql, NativeQuery, OrderBy, NullConstant
from kozmodb_sql.exceptions import PlanningException
from kozmodb_sql.parser.ast import Select, Star, Identifier, Join, Constant, BinaryOperation, Update, BetweenOperation
...
from kozmodb_sql.planner.steps import (
    JoinStep,
    SaveToTable,
    ProjectStep,
    InsertToTable,
    ...
    def test_join_predictor_timeseries(self):
        ...
        expected_plan = QueryPlan(
            steps=[
                ...
                ApplyTimeseriesPredictorStep(namespace='kozmodb',
