...
from kozmodb_sql.planner.steps import (FetchDataframeStep, CreateTableStep, SubSelectStep, UpdateToTable,
                                       DeleteStep)
...
class TestPlanIntegrationSelect:
    ...
    def test_no_integration_error(self):
        ...
        with pytest.raises(PlanningException):
            plan = plan_query(query, integrations=[], predictor_namespace='kozmodb')
    ...
    def test_select_from_single_integration(self):
        ...
        '''
        query = parse_sql(sql_parsed, dialect='kozmodb')
