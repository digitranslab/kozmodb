...
from kozmodb_sql_parser.ast.drop import DropDatabase, DropView
from kozmodb_sql_parser.ast.kozmodb.alter_database import AlterDatabase
from kozmodb_sql_parser.ast.kozmodb.agents import CreateAgent, DropAgent, UpdateAgent
from kozmodb_sql_parser.ast.kozmodb.drop_datasource import DropDatasource
from kozmodb_sql_parser.ast.kozmodb.drop_predictor import DropPredictor
from kozmodb_sql_parser.ast.kozmodb.drop_dataset import DropDataset
from kozmodb_sql_parser.ast.kozmodb.drop_ml_engine import DropMLEngine
from kozmodb_sql_parser.ast.kozmodb.create_predictor import CreatePredictor, CreateAnomalyDetectionModel
from kozmodb_sql_parser.ast.kozmodb.create_database import CreateDatabase
from kozmodb_sql_parser.ast.kozmodb.create_ml_engine import CreateMLEngine
from kozmodb_sql_parser.ast.kozmodb.create_view import CreateView
from kozmodb_sql_parser.ast.kozmodb.alter_view import AlterView
from kozmodb_sql_parser.ast.kozmodb.create_job import CreateJob
from kozmodb_sql_parser.ast.kozmodb.chatbot import CreateChatBot, UpdateChatBot, DropChatBot
from kozmodb_sql_parser.ast.kozmodb.drop_job import DropJob
from kozmodb_sql_parser.ast.kozmodb.trigger import CreateTrigger, DropTrigger
from kozmodb_sql_parser.ast.kozmodb.latest import Latest
from kozmodb_sql_parser.ast.kozmodb.evaluate import Evaluate
from kozmodb_sql_parser.ast.kozmodb.knowledge_base import CreateKnowledgeBase, DropKnowledgeBase, \
    CreateKnowledgeBaseIndex, DropKnowledgeBaseIndex, EvaluateKnowledgeBase
from kozmodb_sql_parser.ast.kozmodb.skills import CreateSkill, DropSkill, UpdateSkill
from kozmodb_sql_parser.exceptions import ParsingException
from kozmodb_sql_parser.ast.kozmodb.retrain_predictor import RetrainPredictor
from kozmodb_sql_parser.ast.kozmodb.finetune_predictor import FinetunePredictor
from kozmodb_sql_parser.utils import ensure_select_keyword_order, JoinType, tokens_to_string
from kozmodb_sql_parser.logger import ParserLogger

from kozmodb_sql_parser.lexer import KozmoDBLexer

all_tokens_list = KozmoDBLexer.tokens.copy()
...
class KozmoDBParser(Parser):
    log = ParserLogger()
    tokens = KozmoDBLexer.tokens
