...
class TestEvaluate:
    ...
    def test_evaluate_full_2(self):
        query_str = """SELECT t.rental_price as ground_truth, m.rental_price as prediction FROM example_db.demo_data.home_rentals as t JOIN kozmodb.home_rentals_model as m limit 100"""
