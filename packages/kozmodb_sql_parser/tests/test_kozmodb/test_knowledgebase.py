from kozmodb_sql_parser.ast.kozmodb.knowledge_base import *
from kozmodb_sql_parser import parse_sql, Variable
from kozmodb_sql_parser.ast.kozmodb.knowledge_base import (
    CreateKnowledgeBase,
    DropKnowledgeBase,
)
...
class TestKB:
    ...
    def test_create_knowledge_base(self):
        ...
        sql = """
            ...
            USING
                MODEL=kozmodb.my_embedding_model,
        ...
        expected_ast = CreateKnowledgeBase(
            ...
            if_not_exists=False,
            model=Identifier(parts=["kozmodb", "my_embedding_model"]),
