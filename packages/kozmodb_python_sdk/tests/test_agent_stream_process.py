...
from kozmodb_sdk.utils.agents import KozmoDBSQLStreamParser

@pytest.fixture
def parser():
    return KozmoDBSQLStreamParser(log_level=logging.INFO)

def test_initialization(parser):
    assert isinstance(parser, KozmoDBSQLStreamParser)
