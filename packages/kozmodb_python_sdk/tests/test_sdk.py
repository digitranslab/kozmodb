...
from kozmodb_sdk.models import ModelVersion, Model
from kozmodb_sdk.tables import Table
import kozmodb_sdk

from kozmodb_sdk.agents import Agent
from kozmodb_sdk.connect import DEFAULT_LOCAL_API_URL, DEFAULT_CLOUD_API_URL
from kozmodb_sdk.skills import SQLSkill
from kozmodb_sdk.connectors import rest_api
...
def check_sql_call(mock, sql, database=None, call_stack_num=None):
    ...
    assert args[0] == 'https://cloud.kozmodb.com/api/sql/query'
    sql_out = kwargs['json']['query']

    # re-render
    sql2 = parse_sql(sql, dialect='kozmodb').to_string()
    sql_out2 = parse_sql(sql_out, dialect='kozmodb').to_string()
...
class BaseFlow:
    ...
    def check_model(self, model, database, mock_post):
        ...
        assert call_args[0][
                   0] == f'https://cloud.kozmodb.com/api/projects/{model.project.name}/models/{model_name}/predict'
...
class Test(BaseFlow):
    ...
    def test_flow(self, mock_post, mock_put, mock_get):
        ...
        # check cloud login
        server = kozmodb_sdk.connect(login='a@b.com')

        call_args = mock_post.call_args
        assert call_args[0][0] == 'https://cloud.kozmodb.com/cloud/login'
        assert call_args[1]['json']['email'] == 'a@b.com'

        # server status
        server.status()
        call_args = mock_get.call_args
        assert call_args[0][0] == 'https://cloud.kozmodb.com/api/status'
        ...
        check_sql_call(
            mock_post, 'CREATE DATABASE proj1 WITH ENGINE = "kozmodb", PARAMETERS = {}')
        self.check_project(project, database)
        ...
        assert call_args[0][0] == 'https://cloud.kozmodb.com/api/files/my_file'
    ...
    def check_project_models(self, project, database, mock_post):
        ...
        sql = '''
         ...
         FROM kozmodb.house_sales_model as m
...
class TestSimplify(BaseFlow):
    ...
    def test_flow(self, mock_post, mock_put):
        ...
        con = kozmodb_sdk.connect(login='a@b.com')
        ...
        response_mock(mock_post,
                      pd.DataFrame([{'NAME': 'mysql', 'TYPE': 'data', 'TITLE': 'MySQL',
                                     'DESCRIPTION': "KozmoDB handler for MySQL",
                                     'CONNECTION_ARGS': {'a': 1}}]))
        ...
        response_mock(mock_post,
                      pd.DataFrame([{'NAME': 'openai', 'TYPE': 'ml', 'TITLE': 'OpenAI',
                                     'DESCRIPTION': "KozmoDB handler for OpenAI",
                                     'CONNECTION_ARGS': {'a': 1}}]))
...
'''
        ...
        call_args = mock_put.call_args
        assert call_args[0][0] == 'https://cloud.kozmodb.com/api/handlers/byom/b1'
...
class TestAgents():
    ...
    def test_list(self, mock_get):
        ...
        # Check API call.
        assert mock_get.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/agents'
    ...
    def test_get(self, mock_get):
        ...
        # Check API call.
        assert mock_get.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/agents/test_agent'
        expected_agent = Agent(
            'test_agent',
            created_at,
            updated_at,
    ...
    def test_create(self, mock_post):
        ...
        assert mock_post.call_args_list[-1][0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/agents'
    ...
    def test_update(self, mock_put, mock_get):
        ...
        # Check API calls.
        assert mock_put.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/agents/test_agent'
    ...
    def test_completion(self, mock_post):
        ...
        # Check API call.
        assert mock_post.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/agents/test_agent/completions'
    ...
    def test_delete(self, mock_delete):
        ...
        # Check API call.
        assert mock_delete.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/agents/test_agent'
    ...
    def test_add_webpage(self, mock_put, mock_get):
        ...
        responses_mock(mock_put, [
            ...
            # Agent update with new data.
            {
                ...
                'prompt_template': 'Documentation for KozmoDB',
                'created_at': None,
                'updated_at': None,
            },
        ])
        server.agents.add_webpage('test_agent', 'docs.mdb.ai', 'Documentation for KozmoDB', 'existing_kb')
...
class TestSkills():
    ...
    def test_list(self, mock_get):
        ...
        assert mock_get.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/skills'
    ...
    def test_get(self, mock_get):
        ...
        # Check API call.
        assert mock_get.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/skills/test_skill'
        expected_skill = SQLSkill('test_skill', ['test_table'], 'test_database', 'test_description')
    ...
    def test_create(self, mock_post):
        ...
        # Check API call.
        assert mock_post.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/skills'
        assert mock_post.call_args[1]['json'] == {
           'skill': {
                'name': 'test_skill',
                'type': 'sql',
    ...
    def test_update(self, mock_put):
        ...
        # Check API call.
        assert mock_put.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/skills/test_skill'
        assert mock_put.call_args[1]['json'] == {
           'skill': {
                'name': 'test_skill',
                'type': 'sql',
    ...
    def test_delete(self, mock_delete):
        ...
        # Check API call.
        assert mock_delete.call_args[0][0] == f'{DEFAULT_LOCAL_API_URL}/api/projects/kozmodb/skills/test_skill'
