...
from kozmodb_sql_parser.ast.kozmodb import CreateJob, DropJob
from kozmodb_sql_parser.ast import Identifier, Star, Select

from kozmodb_sdk.query import Query
from kozmodb_sdk.utils.sql import dict_to_binary_op
from kozmodb_sdk.utils.objects_collection import CollectionBase
from kozmodb_sdk.utils.context import set_saving
...
class Job:
    ...
    def refresh(self):
        """
        Retrieve job data from kozmodb server
        """
...
class Jobs(CollectionBase):
    ...
    def create(
        ...
        More info about jobs: https://docs.kozmodb.com/sql/create/jobs
