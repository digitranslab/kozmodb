...
class Config():
    """
    **Configuration for KozmoDB**
    
    This class provides methods to set and get the various configuration aspects of KozmoDB.
    ...
    def set_default_llm(
        ...
        **kwargs
        ...
        """
        Set the default LLM configuration for KozmoDB.
    ...
    def get_default_llm(self):
        """
        Get the default LLM configuration for KozmoDB.
    ...
    def set_default_embedding_model(
        ...
        **kwargs
        ...
        """
        Set the default embedding model configuration for KozmoDB.
    ...
    def get_default_embedding_model(self):
        """
        Get the default embedding model configuration for KozmoDB.
    ...
    def set_default_reranking_model(
        ...
        **kwargs
        ...
        """
        Set the default reranking model configuration for KozmoDB.
    ...
    def get_default_reranking_model(self):
        """
        Get the default reranking model configuration for KozmoDB.
