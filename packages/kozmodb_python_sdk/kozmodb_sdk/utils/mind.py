...
def create_mind(
    ...
    Args:
        base_url (str): KozmoDB base URL
        api_key (str): KozmoDB API key
        name (str): Mind name
    ...
    warnings.warn(
        'Kozmo in python SDK are deprecated. Use kozmo SDK instead (`pip install kozmo-sdk`)',
        category=DeprecationWarning
    )
    warnings.simplefilter('default', DeprecationWarning)

    url = f"{base_url.rstrip('/')}/kozmo"
