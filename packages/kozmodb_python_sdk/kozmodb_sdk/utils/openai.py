...
from kozmodb_sdk.databases import Database
...
def make_query_tool(schema: dict) -> dict:
    """
    Make an OpenAI tool for querying a database connection in KozmoDB
...
def make_data_tool(
    ...
    """
    tool passing kozmodb database connection details for datasource to litellm callback
...
"""
    ...
    return {
        "type":"function",
        "function":{
            "name":"get_kozmodb_text_to_sql_completion",
...
def query_database(database: Database, query: str) -> str:
    ...
    :param database: kozmodb Database object
