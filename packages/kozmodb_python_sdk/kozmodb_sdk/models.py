...
from kozmodb_sql_parser.ast.kozmodb import CreatePredictor, DropPredictor
from kozmodb_sql_parser.ast.kozmodb import RetrainPredictor, FinetunePredictor
from kozmodb_sql_parser.ast import Identifier, Select, Star, Join, Describe, Set
...
from kozmodb_sdk.utils.objects_collection import CollectionBase
from kozmodb_sdk.utils.sql import dict_to_binary_op, query_to_native_query
from kozmodb_sdk.utils.context import is_saving
    ...
    **Model managing**
    ...
    def predict(self, data: Union[pd.DataFrame, Query, dict], params: dict = None) -> Union[pd.DataFrame, Query]:
        ...
        if isinstance(data, Query):
            ...
            try:
                ast_query = parse_sql(data.sql, dialect='kozmodb')
    ...
    def refresh(self):
        """
        Refresh model data from kozmodb server
...
class Models(CollectionBase):
    ...
    **Models**
    ...
    def create(
        ...
        If query/database is passed, it will be executed on kozmodb side
        ...
        Create, using deferred query. 'query' will be executed and converted to dataframe on kozmodb backend.
        ...
        :param engine: ml engine for new model, default is kozmodb
