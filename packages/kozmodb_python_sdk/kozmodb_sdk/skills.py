...
class SQLSkill(Skill):
    """Represents a KozmoDB skill for agents to interact with KozmoDB databases"""
...
class RetrievalSkill(Skill):
    """Represents a KozmoDB skill for agents to interact with KozmoDB data sources"""
