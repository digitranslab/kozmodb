...
from kozmodb_sql_parser.ast.kozmodb import CreateDatabase, DropPredictor
from kozmodb_sql_parser.ast import DropDatabase
from kozmodb_sql_parser.ast import Identifier

from kozmodb_sdk.agents import Agents
from kozmodb_sdk.skills import Skills
...
class Projects(CollectionBase):
    ...
    def get(self, name: str = 'kozmodb') -> Project:
        """
        Get Project by name
