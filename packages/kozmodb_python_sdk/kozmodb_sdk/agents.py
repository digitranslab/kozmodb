...
from kozmodb_sdk.knowledge_bases import KnowledgeBase
from kozmodb_sdk.models import Model
from kozmodb_sdk.skills import Skill
from kozmodb_sdk.utils.objects_collection import CollectionBase


class AgentCompletion:
    """
    Represents a full KozmoDB agent completion response.
...
class Agents(CollectionBase):
    ...
    def _create_default_knowledge_base(self, agent: Agent, name: str) -> KnowledgeBase:
        try:
            ...
            raise ValueError(
                ...
                "or set your default embedding model via server.config.set_default_embedding_model(...) or through the KozmoDB UI."
            )
    ...
    def create(
        ...
        **kwargs
        ...
        :param provider: Provider of the model, e.g. 'kozmodb', 'openai', etc.
