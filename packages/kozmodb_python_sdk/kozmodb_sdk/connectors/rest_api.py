...
from kozmodb_sdk import __about__
...
class RestAPI:
    ...
    def login(self):
        ...
        # Use newer KozmoDB auth that uses a token
    ...
    def upload_file(self, name: str, data: Union[pd.DataFrame, str]):
        """
        Upload a file or a DataFrame to KozmoDB.
    ...
    def get_config(self):
        """
        Get KozmoDB configuration.
        
        :return: Dictionary containing KozmoDB configuration.
        """
    ...
    def update_config(self, config: dict):
        """
        Update KozmoDB configuration with the provided settings.
