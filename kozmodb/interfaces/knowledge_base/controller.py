...
from kozmodb_sql_parser.ast import BinaryOperation, Constant, Identifier, Select, Update, Delete, Star
from kozmodb_sql_parser.ast.kozmodb import CreatePredictor
from kozmodb_sql_parser import parse_sql

from kozmodb.integrations.libs.keyword_search_base import KeywordSearchBase
from kozmodb.integrations.utilities.query_traversal import query_traversal

import kozmodb.interfaces.storage.db as db
from kozmodb.integrations.libs.vectordatabase_handler import (
    DistanceFunction,
    TableField,
    VectorStoreHandler,
)
from kozmodb.integrations.utilities.rag.rag_pipeline_builder import RAG
from kozmodb.integrations.utilities.rag.config_loader import load_rag_config
from kozmodb.integrations.utilities.handler_utils import get_api_key
from kozmodb.integrations.handlers.langchain_embedding_handler.langchain_embedding_handler import (
    construct_model_from_args,
)

from kozmodb.interfaces.agents.constants import DEFAULT_EMBEDDINGS_MODEL_CLASS, MAX_INSERT_BATCH_SIZE
from kozmodb.interfaces.agents.langchain_agent import create_chat_model, get_llm_provider
from kozmodb.interfaces.database.projects import ProjectController
from kozmodb.interfaces.variables.variables_controller import variables_controller
from kozmodb.interfaces.knowledge_base.preprocessing.models import PreprocessingConfig, Document
from kozmodb.interfaces.knowledge_base.preprocessing.document_preprocessor import PreprocessorFactory
from kozmodb.interfaces.knowledge_base.evaluate import EvaluateBase
from kozmodb.interfaces.knowledge_base.executor import KnowledgeBaseQueryExecutor
from kozmodb.interfaces.model.functions import PredictorRecordNotFound
from kozmodb.utilities.exception import EntityExistsError, EntityNotExistsError
from kozmodb.integrations.utilities.sql_utils import FilterCondition, FilterOperator, KeywordSearchArgs
from kozmodb.utilities.config import config
from kozmodb.utilities.context import context as ctx

from kozmodb.api.executor.command_executor import ExecuteCommands
from kozmodb.api.executor.utilities.sql import query_df
from kozmodb.utilities import log
from kozmodb.integrations.utilities.rag.rerankers.base_reranker import BaseLLMReranker
...
class KnowledgeBaseTable:
    ...
    def _generate_document_id(self, content: str, content_column: str, provided_id: str = None) -> str:
        ...
        from kozmodb.interfaces.knowledge_base.utils import generate_document_id
...
class KnowledgeBaseController:
    ...
    def add(
        ...
        # embedding_model: Identifier = None, # Legacy: Allow KozmoDB models to be passed as embedding_model.
    ) -> db.KnowledgeBase:
        """
