...
from kozmodb.integrations.utilities.rag.settings import DEFAULT_CHUNK_OVERLAP, DEFAULT_CHUNK_SIZE
from kozmodb.integrations.utilities.rag.settings import LLMConfig
...
class PreprocessingConfig(BaseModel):
    ...
    def validate_config_presence(self) -> "PreprocessingConfig":
        ...
        if self.type == PreprocessorType.JSON_CHUNKING and not self.json_chunking_config:
            ...
            from kozmodb.interfaces.knowledge_base.preprocessing.json_chunker import JSONChunkingConfig
