...
from kozmodb.integrations.utilities.rag.splitters.file_splitter import (
    FileSplitter,
    FileSplitterConfig,
)
...
class PreprocessorFactory:
    ...
    def create_preprocessor(
        ...
        if config.type == PreprocessorType.TEXT_CHUNKING:
            ...
            from kozmodb.interfaces.knowledge_base.preprocessing.json_chunker import JSONChunkingPreprocessor
