"""
Wrapper around KozmoDB's executor and integration controller following the implementation of the original
...
class KozmoDBSQL(SQLDatabase):
    @staticmethod
    def custom_init(sql_agent: "SQLAgent") -> "KozmoDBSQL":
        instance = KozmoDBSQL()
