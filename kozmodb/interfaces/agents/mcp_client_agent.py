...
from kozmodb.interfaces.agents.langchain_agent import LangchainAgent
...
class MCPQueryTool(BaseTool):
    ...
    description: ClassVar[str] = "Execute SQL queries against the KozmoDB server via MCP protocol"
