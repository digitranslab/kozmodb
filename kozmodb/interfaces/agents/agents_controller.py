...
from kozmodb.interfaces.storage.db import Predictor
...
class AgentsController:
    ...
    def check_model_provider(self, model_name: str, provider: str = None) -> Tuple[dict, str]:
        ...
        try:
            ...
            provider = "kozmodb" if model.get("provider") is None else model.get("provider")
    ...
    def add_agent(
        ...
        Parameters:
            ...
            params (Dict[str, str]): Parameters to use when running the agent
                ...
                database: The database to use for text2sql skills (default is 'kozmodb')
                knowledge_base_database: The database to use for knowledge base queries (default is 'kozmodb')
    ...
    def get_completion(
        ...
        Parameters:
            ...
            project_name (str): Project the agent belongs to (default kozmodb)
