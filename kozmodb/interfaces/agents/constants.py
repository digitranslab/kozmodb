...
# the same as
# from kozmodb.integrations.handlers.openai_handler.constants import CHAT_MODELS
OPEN_AI_CHAT_MODELS = (
    "gpt-3.5-turbo",
    "gpt-3.5-turbo-16k",
...
DEFAULT_TEXT2SQL_DATABASE = "kozmodb"
DEFAULT_AGENT_SYSTEM_PROMPT = """
You are an AI assistant powered by KozmoDB. You have access to conversation history and should use it to provide contextual responses. When answering questions, follow these guidelines:
...
KOZMODB_PREFIX = """You are an AI assistant powered by KozmoDB. You have access to conversation history and should use it to provide contextual responses. When answering questions, follow these guidelines:
