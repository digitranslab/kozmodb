...
from kozmodb_sql_parser.ast import Select, BinaryOperation, Identifier, Constant, Star

from kozmodb.utilities import log
from kozmodb.utilities.cache import get_cache
from kozmodb.utilities.config import config
from kozmodb.interfaces.storage import db
from kozmodb.interfaces.skills.sql_agent import SQLAgent
from kozmodb.integrations.libs.vectordatabase_handler import TableField
from kozmodb.interfaces.agents.constants import DEFAULT_TEXT2SQL_DATABASE
...
class SkillToolController:
    ...
    def get_command_executor(self):
        if self.command_executor is None:
            ...
            from kozmodb.api.executor.controllers import (
                SessionController,
    ...
    def _make_text_to_sql_tools(self, skills: List[db.Skills], llm) -> List:
        ...
        try:
            from kozmodb.interfaces.agents.kozmodb_database_agent import KozmoDBSQL
            from kozmodb.interfaces.skills.custom.text2sql.kozmodb_sql_toolkit import KozmoDBSQLToolkit
        except ImportError:
            raise ImportError(
                "To use the text-to-SQL skill, please install langchain with `pip install kozmodb[langchain]`"
            )
        ...
        knowledge_base_database = DEFAULT_TEXT2SQL_DATABASE  # Default to kozmodb project
        ...
        #
        #
        # # If no databases were specified or extracted, use 'kozmodb' as a default
        ...
        db = KozmoDBSQL.custom_init(sql_agent=sql_agent)
