...
from kozmodb_sql_parser.ast import Describe, Select, Identifier, Constant, Star
...
class KnowledgeBaseListTool(BaseTool):
    """Tool for listing knowledge bases in KozmoDB."""

    name: str = "kb_list_tool"
    description: str = "List all knowledge bases in KozmoDB."
...
class KnowledgeBaseInfoTool(BaseTool):
    """Tool for getting information about knowledge bases in KozmoDB."""

    name: str = "kb_info_tool"
    description: str = "Get information about knowledge bases in KozmoDB."
...
class KnowledgeBaseQueryTool(BaseTool):
    """Tool for querying knowledge bases in KozmoDB."""

    name: str = "kb_query_tool"
    description: str = "Query knowledge bases in KozmoDB."
