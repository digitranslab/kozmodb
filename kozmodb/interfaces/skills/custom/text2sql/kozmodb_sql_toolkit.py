...
from kozmodb.interfaces.skills.custom.text2sql.kozmodb_sql_tool import KozmoDBSQLParserTool
from kozmodb.interfaces.skills.custom.text2sql.kozmodb_kb_tools import (
...
class KozmoDBSQLToolkit(SQLDatabaseToolkit):
    ...
    def get_tools(self, prefix="") -> List[BaseTool]:
        ...
        query_sql_database_tool_description = dedent(
            ...
            8. Identity and Purpose:
               - When asked about yourself or your maker, state that you are a Data-Mind, created by KozmoDB to help answer data questions.
        ...
        kozmodb_sql_parser_tool_description = (
            "Use this tool to ensure a SQL query passes the KozmoDB SQL parser. "
        ...
        kozmodb_sql_parser_tool = KozmoDBSQLParserTool(
            name=f"kozmodb_sql_parser_tool{prefix}", description=kozmodb_sql_parser_tool_description
        )
        ...
        kb_query_tool = KnowledgeBaseQueryTool(
            ...
            description=dedent(
                ...
                This tool is designed for semantic search and metadata filtering in KozmoDB knowledge bases.
