...
from kozmodb_sql_parser.ast import Select, Show, Describe, Explain, Identifier
...
from kozmodb.integrations.libs.response import INF_SCHEMA_COLUMNS_NAMES
...
from kozmodb.interfaces.data_catalog.data_catalog_reader import DataCatalogReader
...
class SQLAgent:
    ...
    def __init__(
        ...
        knowledge_base_database: str = "kozmodb",
        ...
        Args:
            ...
            knowledge_base_database (str): Project name where knowledge bases are stored (defaults to 'kozmodb')
        ...
        self._kozmodb_db_struct = databases_struct
        ...
        from kozmodb.interfaces.skills.skill_tool import SkillToolController

        # Initialize the skill tool controller from KozmoDB
    ...
    def _call_engine(self, query: str, database=None):
        ...
        if database is None:
            ...
            if self._databases is not None:
                ...
                database = self._databases[0] if self._databases else "kozmodb"
