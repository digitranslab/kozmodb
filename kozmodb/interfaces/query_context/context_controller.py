...
from kozmodb_sql_parser import Select, Star, OrderBy

from kozmodb_sql_parser.ast import Identifier, BinaryOperation, Last, Constant, ASTNode
...
class QueryContextController:
    ...
    def handle_db_context_vars(self, query: ASTNode, dn, session) -> tuple:
        ...
        - params are used to find current values of context variables
          - dn: datanode
          - session: kozmodb server session
