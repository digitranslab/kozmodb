...
class Agents(Base):
    ...
    def as_dict(self) -> Dict:
        ...
        # Since skills were depreciated, they are only used with Kozmo
        # Kozmo expects the parameters to be provided as is without breaking them down
        if skills:
