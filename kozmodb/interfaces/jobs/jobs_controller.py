...
from kozmodb_sql_parser import parse_sql, ParsingException
from kozmodb_sql_parser.ast.kozmodb import CreateJob
from kozmodb_sql_parser.ast import Select, Star, Identifier, BinaryOperation, Constant

from kozmodb.utilities.config import config
from kozmodb.utilities.context import context as ctx
from kozmodb.utilities.exception import EntityNotExistsError, EntityExistsError
...
from kozmodb.interfaces.database.log import LogDBController
...
class JobsController:
    def add(
        ...
        More info: https://docs.kozmodb.com/kozmodb_sql/sql/create/jobs#create-job
