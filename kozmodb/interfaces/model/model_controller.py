...
from kozmodb.interfaces.storage.json import get_json_storage
from kozmodb.interfaces.storage.model_fs import ModelStorage
from kozmodb.utilities.config import config
from kozmodb.utilities.context import context as ctx
from kozmodb.utilities.functions import resolve_model_identifier
...
class ModelController():
    ...
    def get_model_data(self, name: str = None, predictor_record=None, ml_handler_name='lightwood') -> dict:
        ...
        data['kozmodb_version'] = predictor_record.kozmodb_version
    ...
    def get_reduced_model_data(self, name: str = None, predictor_record=None, ml_handler_name='lightwood') -> dict:
        ...
        for k in ['id', 'name', 'version', 'is_active', 'predict', 'status',
                  ...
                  'kozmodb_version', 'error', 'created_at', 'fetch_data_query']:
    ...
    def get_model_info(predictor_record):
        ...
        columns = ['NAME', 'ENGINE', 'PROJECT', 'ACTIVE', 'VERSION', 'STATUS', 'ACCURACY', 'PREDICT', 'UPDATE_STATUS',
                   'KOZMODB_VERSION', 'ERROR', 'SELECT_DATA_QUERY', 'TRAINING_OPTIONS', 'TAG']
        ...
        record = [
            ...
            table_meta['kozmodb_version'], table_meta['error'], table_meta['select_data_query'],
