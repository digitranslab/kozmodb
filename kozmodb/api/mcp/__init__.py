...
from kozmodb.api.executor.data_types.response_type import RESPONSE_TYPE as SQL_RESPONSE_TYPE
...
mcp = FastMCP(
    ...
    dependencies=["kozmodb"],  # Add any additional dependencies
)
...
query_tool_description = dedent("""\
    Executes a SQL query against KozmoDB.
...
def query(query: str, context: dict | None = None) -> dict[str, Any]:
    """Execute a SQL query against KozmoDB
...
list_databases_tool_description = (
    "Returns a list of all database connections currently available in KozmoDB. "
