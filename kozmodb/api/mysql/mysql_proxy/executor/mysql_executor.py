...
from kozmodb.api.executor.planner import utils as planner_utils

import kozmodb.utilities.profiler as profiler
from kozmodb.api.executor.sql_query.result_set import Column
...
from kozmodb.api.mysql.mysql_proxy.utilities import ErSqlSyntaxError
...
class Executor:
    ...
    def stmt_prepare(self, sql):
        ...
        if len(params) == 0:
            ...
            # TODO:
            #   select * from kozmodb.models doesn't invoke prepare_steps and columns_list is empty
