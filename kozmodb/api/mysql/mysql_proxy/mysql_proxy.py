...
import kozmodb.utilities.hooks as hooks
import kozmodb.utilities.profiler as profiler
from kozmodb.utilities.sql import clear_sql
from kozmodb.api.mysql.mysql_proxy.classes.client_capabilities import ClentCapabilities
from kozmodb.api.mysql.mysql_proxy.classes.server_capabilities import (
    server_capabilities,
)
from kozmodb.api.executor.controllers import SessionController
from kozmodb.api.mysql.mysql_proxy.data_types.mysql_packet import Packet
from kozmodb.api.mysql.mysql_proxy.data_types.mysql_packets import (
...
from kozmodb.api.mysql.mysql_proxy.executor import Executor
from kozmodb.api.mysql.mysql_proxy.external_libs.mysql_scramble import (
...
from kozmodb.api.mysql.mysql_proxy.utilities import (
    ErWrongCharset,
    SqlApiException,
)
from kozmodb.api.executor import exceptions as exec_exc

from kozmodb.api.common.middleware import check_auth
from kozmodb.api.mysql.mysql_proxy.libs.constants.mysql import MYSQL_DATA_TYPE
...
from kozmodb.utilities.otel import increment_otel_query_request_counter
from kozmodb.utilities.wizards import make_ssl_cert
from kozmodb.api.mysql.mysql_proxy.utilities.dump import dump_result_set_to_mysql, column_to_mysql_column_dict
...
class MysqlProxy(SocketServer.BaseRequestHandler):
    ...
    def handshake(self):
        ...
        if client_auth_plugin != DEFAULT_AUTH_METHOD:
            ...
            if password == b"\x00":
                ...
                # FIXME https://github.com/digitranslab/kozmodb/issues/1374
    ...
    def _get_column_defenition_packets(self, columns: dict, data=None):
        ...
        for i, column in enumerate(columns):
            ...
            packets.append(
                self.packet(
                    ColumnDefenitionPacket,
                    schema=column.get("database", "kozmodb_schema"),
    ...
    def startProxy():
        ...
        if cert_path is None or cert_path == "":
            cert_path = tempfile.mkstemp(prefix="kozmodb_cert_", text=True)[1]
        ...
        logger.info(f"Starting KozmoDB Mysql proxy server on tcp://{host}:{port}")

        SocketServer.TCPServer.allow_reuse_address = True
        server = SocketServer.ThreadingTCPServer((host, port), MysqlProxy)
        server.kozmodb_config = config
