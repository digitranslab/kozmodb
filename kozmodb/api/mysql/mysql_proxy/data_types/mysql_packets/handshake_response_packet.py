...
from kozmodb.api.mysql.mysql_proxy.libs.constants.mysql import CAPABILITIES
from kozmodb.api.mysql.mysql_proxy.classes.server_capabilities import server_capabilities
