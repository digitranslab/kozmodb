...
from kozmodb.api.a2a.common.server.task_manager import InMemoryTaskManager
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    def _create_agent(self, user_info: Dict, agent_name: str = None) -> KozmoDBAgent:
        """Create a new KozmoDBAgent instance for the given agent name."""
        if not agent_name:
        ...
        if not streaming:
            ...
            try:
                ...
                if "parts" in result:
                    ...
                    result_text = result.get("content", "No response from KozmoDB")
    ...
    async def _invoke(self, request: SendTaskRequest, user_info: Dict) -> SendTaskResponse:
        ...
        try:
            ...
            if streaming:
                ...
                if not all_parts:
                    all_parts = [{"type": "text", "text": "No response from KozmoDB"}]
