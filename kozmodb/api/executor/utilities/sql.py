...
from kozmodb_sql_parser.ast import ASTNode, Select, Identifier, Function, Constant
...
from kozmodb.utilities.functions import resolve_table_identifier, resolve_model_identifier
from kozmodb.utilities.json_encoder import CustomJSONEncoder
from kozmodb.utilities.render.sqlalchemy_render import SqlalchemyRender
from kozmodb.api.executor.utilities.mysql_to_duckdb_functions import mysql_to_duckdb_fnc
...
def query_df(df, query, session=None):
    ...
    Args:
        ...
        query (kozmodb_sql_parser.ast.Select | str): select query
