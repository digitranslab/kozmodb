...
class ApplyPredictorStep(PlanStep):
    """Applies a kozmodb predictor on some dataframe and returns a new dataframe with predictions"""
...
class ApplyPredictorRowStep(PlanStep):
    """Applies a kozmodb predictor to one row of values and returns a dataframe of one row, the predictor."""
