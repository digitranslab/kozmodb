...
import pandas as pd
from kozmodb_sql_parser.ast import BinaryOperation, Constant, Select
from kozmodb_sql_parser.ast.base import ASTNode

from kozmodb.interfaces.agents.agents_controller import AgentsController
from kozmodb.interfaces.jobs.jobs_controller import JobsController
from kozmodb.interfaces.skills.skills_controller import SkillsController
...
from kozmodb.api.executor.datahub.datanodes.system_tables import Table
...
class TriggersTable(MdbTable):
    ...
    kozmodb_columns = ["NAME", "PROJECT", "DATABASE", "TABLE", "QUERY", "LAST_ERROR"]
...
class KBTable(MdbTable):
    ...
    def get_data(cls, query: ASTNode = None, inf_schema=None, **kwargs):
        ...
        from kozmodb.interfaces.knowledge_base.controller import KnowledgeBaseController
