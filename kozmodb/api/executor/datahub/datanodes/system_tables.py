...
from kozmodb.integrations.utilities.sql_utils import extract_comparison_conditions
...
from kozmodb.api.mysql.mysql_proxy.libs.constants.mysql import MYSQL_DATA_TYPE, MYSQL_DATA_TYPE_COLUMNS_DEFAULT
from kozmodb.api.executor.datahub.classes.tables_row import TABLES_ROW_TYPE, TablesRow
...
class ColumnsTableRow:
    """Represents a row in the KozmoDB's internal INFORMATION_SCHEMA.COLUMNS table.
    ...
    def from_is_columns_row(cls, table_schema: str, table_name: str, row: pd.Series) -> "ColumnsTableRow":
        ...
        Returns:
            ColumnsTableRow: A row in the KozmoDB's internal INFORMATION_SCHEMA.COLUMNS table.
        """
