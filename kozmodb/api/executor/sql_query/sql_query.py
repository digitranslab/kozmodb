...
import pandas as pd
from kozmodb_sql_parser import parse_sql, ASTNode
...
from kozmodb.api.executor.planner import query_planner

from kozmodb.api.executor.utilities.sql import get_query_models
from kozmodb.interfaces.model.functions import get_model_record
...
from kozmodb.utilities.fs import create_process_mark, delete_process_mark
...
class SQLQuery:
    ...
    def execute_query(self):
        ...
        try:
            ...
            for col in self.fetched_data.find_columns('__kozmodb_row_id'):
