...
def download_gui(destignation, version):
    ...
    bucket = "https://kozmodb-web-builds.s3.amazonaws.com/"
...
def update_static(gui_version: Version):
    ...
    temp_dir = tempfile.mkdtemp(prefix="kozmodb_gui_files_")
    success = download_gui(temp_dir, gui_version.base_version)
    if success is False:
        shutil.rmtree(temp_dir)
        return False

    temp_dir_for_rm = tempfile.mkdtemp(prefix="kozmodb_gui_files_")
