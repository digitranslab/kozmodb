...
from kozmodb.api.http.namespaces.configs.default import ns_conf
...
from kozmodb.api.common.middleware import generate_pat, revoke_pat, verify_pat
    ...
    @ns_conf.doc(
        ...
        model=ns_conf.model(
            "response_status",
            {
                ...
                "kozmodb_version": fields.String(description="Current version of kozmodb"),
                "auth": fields.Nested(
                    ns_conf.model(
