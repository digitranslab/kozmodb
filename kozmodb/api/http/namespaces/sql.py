...
from kozmodb.api.http.namespaces.configs.sql import ns_conf
...
from kozmodb.api.executor.data_types.response_type import (
    RESPONSE_TYPE as SQL_RESPONSE_TYPE,
)
from kozmodb.api.executor.exceptions import ExecutorException, UnknownError
...
@ns_conf.param("list_databases", "lists databases of kozmodb")
