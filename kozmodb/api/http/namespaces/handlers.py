...
class HandlerIcon(Resource):
    ...
    def get(self, handler_name):
        try:
            ...
            icon_path = kozmodb_path.joinpath("integrations/handlers").joinpath(handler_folder).joinpath(icon_name)
...
def prepare_formdata():
    ...
    temp_dir_path = tempfile.mkdtemp(prefix="kozmodb_file_")
