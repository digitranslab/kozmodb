...
from kozmodb.api.http.namespaces.configs.tabs import ns_conf
...
from kozmodb.interfaces.tabs.tabs_controller import tabs_controller, get_storage, TABS_FILENAME
