...
from kozmodb.api.http.namespaces.configs.util import ns_conf
...
def get_active_tasks():
    ...
    for process_type in response:
        processes_dir = Path(tempfile.gettempdir()).joinpath(f'kozmodb/processes/{process_type}/')
...
class PingMLTaskQueue(Resource):
    ...
    def get(self):
        ...
        processes_dir = Path(tempfile.gettempdir()).joinpath('kozmodb/processes/internal/')
