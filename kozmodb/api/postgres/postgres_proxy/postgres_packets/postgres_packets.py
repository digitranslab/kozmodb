...
class PostgresPacketReader:
    def __init__(self, buffer: BinaryIO):
        from kozmodb.api.postgres.postgres_proxy.postgres_packets.postgres_message_formats import FE_MESSAGE_MAP, \
    ...
    def read_authentication(self, encoding=None):
        try:
            ...
            # No authentication parameters specified. Which is fine if we're local on a kozmodbuser
            return ''
        try:
