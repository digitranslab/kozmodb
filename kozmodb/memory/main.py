...
from kozmodb.configs.base import MemoryConfig, MemoryItem
from kozmodb.configs.enums import MemoryType
from kozmodb.configs.prompts import (
...
from kozmodb.utils.factory import EmbedderFactory, LlmFactory, VectorStoreFactory
...
class Memory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        capture_event("kozmodb.init", self, {"sync_type": "sync"})
        ...
        *,
        ...
        if self.api_version == "v1.0":
            warnings.warn(
                ...
                "The current format will be removed in kozmodb 1.1.0 and later versions.",
    ...
    def get(self, memory_id):
        ...
        """
        capture_event("kozmodb.get", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def get_all(
        ...
        *,
        ...
        capture_event(
            "kozmodb.get_all", self, {"limit": limit, "keys": list(effective_filters.keys()), "sync_type": "sync"}
        )
        ...
        if self.api_version == "v1.0":
            warnings.warn(
                ...
                "The current format (direct list for v1.0) will be removed in kozmodb 1.1.0 and later versions.",
                category=DeprecationWarning,
                stacklevel=2,
            )
    ...
    def update(self, memory_id, data):
        ...
        Returns:
            dict: Updated memory.
        """
        capture_event("kozmodb.update", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def delete(self, memory_id):
        ...
        """
        capture_event("kozmodb.delete", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def delete_all(self, user_id: Optional[str] = None, agent_id: Optional[str] = None, run_id: Optional[str] = None):
        ...
        capture_event("kozmodb.delete_all", self, {"keys": list(filters.keys()), "sync_type": "sync"})
    ...
    def history(self, memory_id):
        ...
        """
        capture_event("kozmodb.history", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def _create_memory(self, data, existing_embeddings, metadata=None):
        ...
        capture_event("kozmodb._create_memory", self, {"memory_id": memory_id, "sync_type": "sync"})
        return memory_id
    ...
    def _create_procedural_memory(self, messages, metadata=None, prompt=None):
        ...
        capture_event("kozmodb._create_procedural_memory", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def _update_memory(self, memory_id, data, existing_embeddings, metadata=None):
        ...
        capture_event("kozmodb._update_memory", self, {"memory_id": memory_id, "sync_type": "sync"})
        return memory_id
    ...
    def _delete_memory(self, memory_id):
        ...
        capture_event("kozmodb._delete_memory", self, {"memory_id": memory_id, "sync_type": "sync"})
        return memory_id
    ...
    def reset(self):
        ...
        capture_event("kozmodb.reset", self, {"sync_type": "sync"})
...
class AsyncMemory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        capture_event("kozmodb.init", self, {"sync_type": "async"})
    ...
    async def _add_to_vector_store(
        ...
        capture_event(
            "kozmodb.add", self, {"version": self.api_version, "keys": list(filters.keys()), "sync_type": "async"}
        )
        return returned_memories
    ...
    async def get(self, memory_id):
        ...
        Returns:
            dict: Retrieved memory.
        """
        capture_event("kozmodb.get", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def get_all(
        ...
        *,
        ...
        capture_event(
            "kozmodb.get_all", self, {"limit": limit, "keys": list(effective_filters.keys()), "sync_type": "async"}
        )
    ...
    async def update(self, memory_id, data):
        ...
        Returns:
            dict: Updated memory.
        """
        capture_event("kozmodb.update", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def delete(self, memory_id):
        ...
        Args:
            memory_id (str): ID of the memory to delete.
        """
        capture_event("kozmodb.delete", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def delete_all(self, user_id=None, agent_id=None, run_id=None):
        ...
        capture_event("kozmodb.delete_all", self, {"keys": list(filters.keys()), "sync_type": "async"})
    ...
    async def history(self, memory_id):
        ...
        Returns:
            list: List of changes for the memory.
        """
        capture_event("kozmodb.history", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def _create_memory(self, data, existing_embeddings, metadata=None):
        ...
        capture_event("kozmodb._create_memory", self, {"memory_id": memory_id, "sync_type": "async"})
        return memory_id
    ...
    async def _create_procedural_memory(self, messages, metadata=None, llm=None, prompt=None):
        ...
        capture_event("kozmodb._create_procedural_memory", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def _update_memory(self, memory_id, data, existing_embeddings, metadata=None):
        ...
        capture_event("kozmodb._update_memory", self, {"memory_id": memory_id, "sync_type": "async"})
        return memory_id
    ...
    async def _delete_memory(self, memory_id):
        ...
        capture_event("kozmodb._delete_memory", self, {"memory_id": memory_id, "sync_type": "async"})
        return memory_id
    ...
    async def reset(self):
        ...
        capture_event("kozmodb.reset", self, {"sync_type": "async"})
