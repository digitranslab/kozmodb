...
from kozmodb.integrations.handlers.litellm_handler.settings import CompletionParameters
...
class LiteLLMHandler(BaseMLEngine):
    """
    LiteLLMHandler is a KozmoDB handler for litellm - https://docs.litellm.ai/docs/
    """
