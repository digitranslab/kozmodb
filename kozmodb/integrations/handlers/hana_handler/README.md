...
This documentation describes the integration of KozmoDB with [SAP HANA](https://www.sap.com/products/technology-platform/hana/what-is-sap-hana.html), a multi-model database with a column-oriented in-memory design that stores data in its memory instead of keeping it on a disk.
The integration allows KozmoDB to access data from SAP HANA and enhance SAP HANA with AI capabilities.
...
Establish a connection to SAP HANA from KozmoDB by executing the following SQL command and providing its [handler name](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/hana_handler) as an engine.
...
* **Symptoms**: Failure to connect KozmoDB with the SAP HANA database.
* **Checklist**:
    ...
    3. Ensure a stable network between KozmoDB and SAP HANA.
</Warning>
