...
from kozmodb.integrations.libs.response import HandlerResponse
...
from kozmodb.integrations.libs.vectordatabase_handler import FilterCondition, FilterOperator, TableField, VectorStoreHandler
...
class MilvusHandler(VectorStoreHandler):
    ...
    def __init__(self, name: str, **kwargs):
        ...
        self._create_table_params = {
            ...
            "create_schema_description": "KozmoDB generated table",
    ...
    def get_columns(self, table_name: str) -> HandlerResponse:
        ...
        try:
            ...
            schema = [kozmodb_schema_field for kozmodb_schema_field in self.SCHEMA if kozmodb_schema_field["name"] in field_names]
