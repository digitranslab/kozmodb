...
This is the implementation of the Milvus for KozmoDB.
...
In order to make use of this handler and connect to a Milvus server in KozmoDB, the following syntax can be used:
