...
from kozmodb.integrations.libs.api_handler import MetaAPIHandler
...
from kozmodb.integrations.handlers.salesforce_handler.constants import get_soql_instructions
