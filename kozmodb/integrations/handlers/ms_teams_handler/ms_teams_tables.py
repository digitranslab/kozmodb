...
from kozmodb.integrations.handlers.ms_teams_handler.ms_graph_api_teams_client import MSGraphAPITeamsDelegatedPermissionsClient
from kozmodb.integrations.libs.api_handler import APIResource
