...
This documentation describes the integration of KozmoDB with [Google Gemini](<link>), a generative artificial intelligence model developed by Google. The integration allows for the deployment of Google Gemini models within KozmoDB, providing the models with access to data from various data sources.
...
2. To use Google Gemini within KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
3. Obtain the Google Gemini API key required to deploy and use Google Gemini models within KozmoDB. Follow the [instructions for obtaining the API key](https://ai.google.dev/gemini-api/docs/api-key).

## Setup

Create an AI engine from the [Google Gemini handler](https://github.com/digitranslab/kozmodb/tree/main/kozmodb/integrations/handlers/google_gemini_handler).
...
![image](https://github.com/digitranslab/kozmodb/assets/75653580/aad51d3f-4458-4bcc-b4a3-07983496d2fe)
