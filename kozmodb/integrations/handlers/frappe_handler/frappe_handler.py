...
from kozmodb.integrations.handlers.frappe_handler.frappe_tables import FrappeDocumentsTable
from kozmodb.integrations.handlers.frappe_handler.frappe_client import FrappeClient
