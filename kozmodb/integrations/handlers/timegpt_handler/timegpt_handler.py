...
from kozmodb.integrations.utilities.time_series_utils import get_results_from_nixtla_df
# TODO: add E2E tests.
...
class TimeGPTHandler(BaseMLEngine):
    ...
    def predict(self, df, args={}):
        ...
        forecast_df = timegpt.forecast(
            ...
            # TODO: supporting param override when JOINing with a WHERE clause is blocked by kozmodb_sql#285
        ...
        for i, level in enumerate(levels):
            if i == 0:
                # NOTE: this should be simplified once we refactor the expected time series output within KozmoDB
