...
from kozmodb.integrations.libs.api_handler_exceptions import MissingConnectionParams

from kozmodb.integrations.handlers.twelve_labs_handler.settings import TwelveLabsHandlerModel
from kozmodb.integrations.handlers.twelve_labs_handler.twelve_labs_api_client import TwelveLabsAPIClient
...
class TwelveLabsHandler(BaseMLEngine):
    ...
    def describe(self, attribute: Optional[str] = None) -> pd.DataFrame:
        ...
        if attribute == "args":
            ...
            # KozmoDB GUI fails to display NaN values, so we replace them with 0
