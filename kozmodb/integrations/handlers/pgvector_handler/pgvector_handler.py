...
from kozmodb.integrations.handlers.postgres_handler.postgres_handler import (
    PostgresHandler,
)
from kozmodb.integrations.libs.response import RESPONSE_TYPE, HandlerResponse as Response
...
from kozmodb.integrations.utilities.sql_utils import KeywordSearchArgs
...
class PgVectorHandler(PostgresHandler, VectorStoreHandler, KeywordSearchBase):
    ...
    def select(
        ...
        # ensure embeddings are returned as string so they can be parsed by kozmodb
