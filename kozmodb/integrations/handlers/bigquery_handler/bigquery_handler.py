...
from kozmodb.integrations.libs.base import MetaDatabaseHandler
from kozmodb.utilities.render.sqlalchemy_render import SqlalchemyRender
from kozmodb.integrations.utilities.handlers.auth_utilities.google import GoogleServiceAccountOAuth2Manager
...
class BigQueryHandler(MetaDatabaseHandler):
    ...
    def connect(self):
        ...
        Raises:
            ...
            kozmodb.integrations.utilities.handlers.auth_utilities.exceptions.NoCredentialsException: If none of the required forms of credentials are provided.
            kozmodb.integrations.utilities.handlers.auth_utilities.exceptions.AuthException: If authentication fails.
