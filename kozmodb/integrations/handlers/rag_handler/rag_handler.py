...
from kozmodb.integrations.handlers.rag_handler.ingest import RAGIngestor
from kozmodb.integrations.handlers.rag_handler.rag import RAGQuestionAnswerer
from kozmodb.integrations.handlers.rag_handler.settings import (
...
logger.warning("\nThe RAG handler has been deprecated and is no longer being actively supported. \n"
               ...
               "https://github.com/digitranslab/kozmodb_python_sdk/blob/staging/examples"
               "/using_agents_with_retrieval.py")


class RAGHandler(BaseMLEngine):
    """
    RAGHandler is a KozmoDB integration with supported LLM APIs allows users to run question answering
