...
from kozmodb.interfaces.storage.fs import RESOURCE_GROUP, FileStorage
...
def create_learn_mark():
    if os.name == 'posix':
        p = Path(tempfile.gettempdir()).joinpath('kozmodb/learn_processes/')
...
def delete_learn_mark():
    if os.name == 'posix':
        p = (
            ...
            .joinpath('kozmodb/learn_processes/')
