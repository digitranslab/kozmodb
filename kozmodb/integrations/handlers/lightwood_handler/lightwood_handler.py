...
from kozmodb.utilities.functions import cast_row_types
...
class LightwoodHandler(BaseMLEngine):
    ...
    def predict(self, df, args=None):
        ...
        with profiler.Context('predict-postprocessing'):
            ...
            if timeseries_settings['is_timeseries'] is True:
                ...
                for group, data in rows_by_groups.items():
                    ...
                    for i in range(len(last_row[target])):
                        ...
                        if '__kozmodb_row_id' in new_row and (i > 0 or forecast_offset):
                            new_row['__kozmodb_row_id'] = None
            ...
            data = []
            explains = []
            keys_to_save = [*keys, '__kozmodb_row_id', 'select_data_query', 'when_data']
