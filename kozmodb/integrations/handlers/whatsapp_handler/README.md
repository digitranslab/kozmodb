...
Whatsapp handler for KozmoDB facilitates the ability to send messages to your Whatsapp using Twilio Whastapp APIs and retrieve the conversation history.
...
All things are in place now, in order to use the Whatsapp Using KozmoDB.
