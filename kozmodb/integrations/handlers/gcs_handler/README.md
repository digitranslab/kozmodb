...
This documentation describes the integration of KozmoDB with [Google Cloud Storage](https://cloud.google.com/storage), an object storage service that offers industry-leading scalability, data availability, security, and performance.
...
Establish a connection to your GCS bucket from KozmoDB by executing the following SQL command:
...
* **Symptoms**: Failure to connect KozmoDB with the GCS bucket.
* **Checklist**:
    ...
    3. Ensure a stable network between KozmoDB and GCP.
</Warning>
