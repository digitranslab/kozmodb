...
from kozmodb.interfaces.agents.safe_output_parser import SafeOutputParser
from kozmodb.interfaces.agents.langchain_agent import (
    get_llm_provider,
...
from kozmodb.integrations.handlers.langchain_handler.tools import setup_tools
from kozmodb.integrations.libs.base import BaseMLEngine
from kozmodb.interfaces.storage.model_fs import HandlerStorage, ModelStorage
...
from kozmodb.integrations.handlers.openai_handler.constants import CHAT_MODELS_PREFIXES  # noqa: F401 - for dependency checker
...
class LangChainHandler(BaseMLEngine):
    """
    This is a KozmoDB integration for the LangChain library, which provides a unified interface for interacting with
