...
class AmazonBedrockHandlerModelConfig(BaseModel):
    ...
    """
    # User-provided Handler Model Prameters: These are parameters specific to the KozmoDB handler for Amazon Bedrock provided by the user.
    id: Text = Field(None)
    ...
    # System-provided Handler Model Parameters: These are parameters specific to the KozmoDB handler for Amazon Bedrock provided by the system.
