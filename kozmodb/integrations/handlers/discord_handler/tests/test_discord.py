...
from kozmodb_sql_parser.ast import BinaryOperation, Identifier, Constant
from kozmodb_sql_parser.ast.select.star import Star
from kozmodb.integrations.handlers.discord_handler.discord_handler import DiscordHandler
...
class DiscordHandlerTest(unittest.TestCase):
    ...
    @patch('kozmodb.integrations.handlers.discord_handler.discord_handler.requests.get')
    ...
    @patch(
        'kozmodb.integrations.handlers.discord_handler.discord_handler.requests.post'
    )
