...
from kozmodb.integrations.handlers.ckan_handler.ckan_handler import CkanHandler
...
class CkanHandlerTest(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch('kozmodb.integrations.handlers.ckan_handler.ckan_handler.RemoteCKAN')
