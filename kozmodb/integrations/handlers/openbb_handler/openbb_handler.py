...
from kozmodb.integrations.handlers.openbb_handler.openbb_tables import create_table_class
...
from kozmodb.integrations.handlers.openbb_handler.openbb_tables import OpenBBtable
