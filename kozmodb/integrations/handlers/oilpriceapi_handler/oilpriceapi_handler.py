from kozmodb.integrations.handlers.oilpriceapi_handler.oilpriceapi_tables import (
    OilPriceLatestTable,
    OilPricePastDayPriceTable
)
from kozmodb.integrations.handlers.oilpriceapi_handler.oilpriceapi import OilPriceAPIClient
