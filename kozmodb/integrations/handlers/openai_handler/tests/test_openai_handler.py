...
class TestOpenAI(BaseMLAPITest):
    ...
    #         {
    #             "prompt": [
    #                 "What is the SQL syntax to connect a database to KozmoDB?",
    #                 "What is the SQL command to connect to the demo postgres database for KozmoDB learning hub examples?",
    #                 "What is the SQL syntax to create a KozmoDB machine learning model?",
    #                 "What is the SQL syntax to join input data with predictions from a KozmoDB machine learning model?"
    #             ],
    #             "completion": [
    #                 """
    ...
    #             prompt_template = 'Return a valid SQL string for the following question about KozmoDB in-database machine learning: {{{{prompt}}}}';
    #         """
    #     )
    ...
    #         WHERE prompt = 'What is the SQL syntax to join input data with predictions from a KozmoDB machine learning model?'
