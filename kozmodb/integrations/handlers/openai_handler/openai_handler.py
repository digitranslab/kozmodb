...
from kozmodb.utilities.hooks import before_openai_query, after_openai_query
from kozmodb.utilities import log
from kozmodb.integrations.libs.base import BaseMLEngine
from kozmodb.integrations.handlers.openai_handler.helpers import (
    retry_with_exponential_backoff,
    truncate_msgs_for_token_limit,
    get_available_models,
    PendingFT,
)
from kozmodb.integrations.handlers.openai_handler.constants import (
...
from kozmodb.integrations.libs.llm.utils import get_completed_prompts
...
class OpenAIHandler(BaseMLEngine):
    ...
    def finetune(self, df: Optional[pd.DataFrame] = None, args: Optional[Dict] = None) -> None:
        """
        Fine-tune OpenAI GPT models via a KozmoDB model connected to the OpenAI API.
        Steps are roughly:
