...
from kozmodb.integrations.handlers.google_fit_handler.google_fit_tables import GoogleFitTable
...
class GoogleFitHandler(APIHandler):
    def __init__(self, name: str = None, **kwargs):
        ...
        if "service_account_file" in args:
            ...
            self.credentials_path = "kozmodb/integrations/handlers/google_fit_handler/credentials.json"
        else:
    ...
    def connect(self) -> Resource:
        ...
        if os.path.isfile("kozmodb/integrations/handlers/google_fit_handler/token.json"):
            creds = Credentials.from_authorized_user_file(
                "kozmodb/integrations/handlers/google_fit_handler/token.json", SCOPES
            )
        if not creds or not creds.valid:
            ...
            with open("kozmodb/integrations/handlers/google_fit_handler/token.json", "w") as token:
