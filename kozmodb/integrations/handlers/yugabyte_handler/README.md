...
This is the implementation of the YugabyteDB handler for KozmoDB.
...
In order to make use of this handler and connect to yugabyte in KozmoDB, the following syntax can be used,
...
NOTE : If you are using YugabyteDB Cloud with KozmoDB Cloud website you need to add below 3 static IPs of KozmoDB Cloud to `allow IP list` for accessing it publicly.
```
18.220.205.95
3.19.152.46
52.14.91.162
