...
class LeonardoAIHandler(BaseMLEngine):
    """
    This integration seamlessly combines KozmoDB and Leonardo AI to create a powerful
    ...
    def describe(self, attribute: Optional[str] = None) -> pd.DataFrame:
        ...
        if attribute == "features":
            return pd.DataFrame([[target, prompt_template]], columns=['target_column', 'kozmodb_prompt_template'])
