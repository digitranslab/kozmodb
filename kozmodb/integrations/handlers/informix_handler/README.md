...
This is the implementation of the IBM Informix handler for KozmoDB. The `IfxPy` library is not currently being published to PyPI. As a workaround, you need to install it directly from the GitHub repository:
...
## Usage
In order to make use of this handler and connect to Informix in KozmoDB, the following syntax can be used,
~~~~sql
