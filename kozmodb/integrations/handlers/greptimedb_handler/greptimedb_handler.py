"""
This is the GreptimeDB integration handler for kozmodb.  It provides the routines
...
Because GreptimeDB has built-in MySQL wire protocol support, this handler is simply
 a subclass of kozmodb's MySQL handler
"""

from kozmodb.integrations.handlers.mysql_handler import Handler as MySQLHandler
