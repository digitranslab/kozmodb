from kozmodb.integrations.handlers.strava_handler.strava_tables import StravaAllClubsTable
from kozmodb.integrations.handlers.strava_handler.strava_tables import StravaClubActivitesTable
