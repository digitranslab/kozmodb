...
from kozmodb.integrations.handlers.postgres_handler.tests.test_postgres_handler import (
...
from kozmodb.integrations.handlers.redshift_handler.redshift_handler import RedshiftHandler
...
def seed_db():
    ...
    with open("kozmodb/integrations/handlers/redshift_handler/tests/seed.sql", "r") as f:
