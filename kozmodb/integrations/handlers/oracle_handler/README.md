...
This documentation describes the integration of KozmoDB with [Oracle](https://www.techopedia.com/definition/8711/oracle-database), one of the most trusted and widely used relational database engines for storing, organizing and retrieving data by type while still maintaining relationships between the various types.
...
2. To connect Oracle to KozmoDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).

## Connection

Establish a connection to your Oracle database from KozmoDB by executing the following SQL command:
...
* **Symptoms**: Failure to connect KozmoDB with the Oracle database.
* **Checklist**:
    ...
    3. Ensure a stable network between KozmoDB and Oracle.
</Warning>
