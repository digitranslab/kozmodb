import unittest
from kozmodb.integrations.handlers.google_calendar_handler.google_calendar_handler import GoogleCalendarHandler
...
class GoogleCalendarHandlerTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.kwargs = {
            "connection_data": {
                "credentials": "C:\\Users\\panagiotis\\Desktop\\GitHub\\kozmodb\\kozmodb\\integrations\\handlers"
