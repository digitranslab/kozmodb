...
import kozmodb.interfaces.storage.db
...
def upgrade():
    ...
    op.create_table(
        'analysis',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('analysis', kozmodb.interfaces.storage.db.Json(), nullable=False),
    ...
    for ds in dsatasources:
        ...
        if datasource_name == 'file':
            ...
            file = kozmodb.interfaces.storage.db.File(
                name=ds['name'],
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column('query_fields', kozmodb.interfaces.storage.db.Json(), nullable=False),
        sa.Column('predictor_name', sa.String(), nullable=False),
        sa.Column('predictor_columns', kozmodb.interfaces.storage.db.Json(), nullable=False),
        sa.Column('company_id', sa.Integer(), nullable=True),
        sa.PrimaryKeyConstraint('id')
    )
