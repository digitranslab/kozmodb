...
import kozmodb.interfaces.storage.db  # noqa
...
def upgrade(op: Operations = None):
    ...
    op.create_table(
        ...
        sa.Column('columns', kozmodb.interfaces.storage.db.Json(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('data', kozmodb.interfaces.storage.db.Json(), nullable=True),
        sa.Column('company_id', sa.Integer(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(), nullable=True),
        sa.Column('data', kozmodb.interfaces.storage.db.Json(), nullable=True),
        sa.Column('to_predict', kozmodb.interfaces.storage.db.Array(), nullable=True),
        sa.Column('company_id', sa.Integer(), nullable=True),
        sa.Column('kozmodb_version', sa.String(), nullable=True),
        sa.Column('native_version', sa.String(), nullable=True),
        sa.Column('integration_id', sa.Integer(), nullable=True),
        sa.Column('data_integration_ref', kozmodb.interfaces.storage.db.Json(), nullable=True),
        sa.Column('fetch_data_query', sa.String(), nullable=True),
        sa.Column('learn_args', kozmodb.interfaces.storage.db.Json(), nullable=True),
        ...
        sa.Column('dtype_dict', kozmodb.interfaces.storage.db.Json(), nullable=True),
        sa.Column('project_id', sa.Integer(), nullable=False),
