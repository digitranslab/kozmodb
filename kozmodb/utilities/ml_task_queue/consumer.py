...
from kozmodb.utilities.ml_task_queue.utils import RedisKey, StatusNotifier, to_bytes, from_bytes
from kozmodb.utilities.ml_task_queue.base import BaseRedisQueue
from kozmodb.utilities.fs import clean_unlinked_process_marks
from kozmodb.utilities.functions import mark_process
from kozmodb.utilities.ml_task_queue.const import (
    ML_TASK_TYPE,
    ML_TASK_STATUS,
    TASKS_STREAM_NAME,
...
class MLTaskConsumer(BaseRedisQueue):
    ...
    def wait_free_resources(self) -> None:
        ...
        processes_dir = Path(tempfile.gettempdir()).joinpath('kozmodb/processes/learn/')
        while True:
