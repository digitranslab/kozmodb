...
How to use it:
    ...
    from kozmodb.utilities.cache import get_cache, dataframe_checksum, json_checksum
...
Can be specified in kozmodb config json. Possible values:
...
from kozmodb.interfaces.storage.fs import FileLock
