...
KOZMODB_PROFILING_ENABLED = os.environ.get("KOZMODB_PROFILING_ENABLED") in ("1", "true")
KOZMODB_PROFILING_DB_HOST = os.environ.get("KOZMODB_PROFILING_DB_HOST")
KOZMODB_PROFILING_DB_USER = os.environ.get("KOZMODB_PROFILING_DB_USER")
KOZMODB_PROFILING_DB_PASSWORD = os.environ.get("KOZMODB_PROFILING_DB_PASSWORD")
...
def send_profiling_results(profiling_data: dict):
    if KOZMODB_PROFILING_ENABLED is False:
        return
    ...
    try:
        connection = psycopg.connect(
            host=KOZMODB_PROFILING_DB_HOST,
            port=5432,
            user=KOZMODB_PROFILING_DB_USER,
            password=KOZMODB_PROFILING_DB_PASSWORD,
            dbname="postgres",
            connect_timeout=5
        )
    except Exception:
