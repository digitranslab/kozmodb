...
from kozmodb.utilities.otel.logger import setup_logger
from kozmodb.utilities.otel.meter import setup_meter
from kozmodb.utilities.otel.tracer import setup_tracer
from kozmodb.utilities.utils import parse_csv_attributes
...
# Define service name
OTEL_SERVICE_NAME = os.getenv("OTEL_SERVICE_NAME", "kozmodb")

# Define service instace ID
OTEL_SERVICE_INSTANCE_ID = os.getenv("OTEL_SERVICE_INSTANCE_ID", "kozmodb-instance")
