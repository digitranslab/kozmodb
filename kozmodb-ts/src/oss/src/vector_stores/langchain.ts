...
import { VectorStore } from "./base"; // kozmodb's VectorStore interface
...
export class LangchainVectorStore implements VectorStore {
  ...
  async search(
    ...
    // Filters passed via kozmodb interface are not reliably translatable to generic Langchain stores.
